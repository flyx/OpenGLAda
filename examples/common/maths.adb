...
package body Maths is
    ...
    function To_3 (Array_4 : Single_Array) return Single_Array is
        Array_3  : Single_Array (0 .. Array_4'Length * 3 / 4 - 1);
        Index_3  : Int;
        Index_4  : Int;
    begin
        Index_3 := 0;
        Index_4 := 0;
        while Index_4 < Array_4'Length - 1 loop
            Array_3 (Index_3) := Array_4 (Index_4);
            Array_3 (Index_3 + 1) := Array_4 (Index_4 + 1);
            Array_3 (Index_3 + 2) := Array_4 (Index_4 + 2);
            Index_3 := Index_3 + 3;
            Index_4 := Index_4 + 4;
        end loop;
        return Array_3;
    ...
    function To_4 (Array_3 : Single_Array) return Single_Array is
        Array_4  : Single_Array (0 .. Array_3'Length * 4 / 3 - 1);
        Index_3  : Int;
        Index_4  : Int;
    begin
        Index_3 := 0;
        Index_4 := 0;
        while Index_3 < Array_3'Length - 1 loop
            Array_4 (Index_4) := Array_3 (Index_3);
            Array_4 (Index_4 + 1) := Array_3 (Index_3 + 1);
            Array_4 (Index_4 + 2) := Array_3 (Index_3 + 2);
            Array_4 (Index_4 + 3) := 1.0;
            Index_3 := Index_3 + 3;
            Index_4 := Index_4 + 4;
        end loop;
        return Array_4;
