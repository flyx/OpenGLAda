...
package FT_Glyphs is
   ...
   function Get_Bitmap (Glyph_Slot : FT_Types.FT_Glyph_Slot) return FT_Image.FT_Bitmap;
   ...
   function Get_Glyph_Format (Slot_Ptr : FT_Types.FT_Glyph_Slot) return FT_Image.FT_Glyph_Format;
