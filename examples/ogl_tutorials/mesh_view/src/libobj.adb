...
package body libOBJ is
   ...
   -- First pass of the obj file: count number of vertices, triangles etc.
   ...
   -- Second pass of the obj file: collect the vertices, triangles etc.
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            -- read png once, saving rgb values in colour_table
