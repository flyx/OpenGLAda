-- $Id: png_io-write_png_type_2.adb,v 1.6 2009/05/04 19:31:14 sangwine Exp $
---------------------------------------------------------------------
---------------------------------------------------------------------
            ...
            for Col in 0 .. Coordinate (X - 1) loop
               ...
               begin
                  ...
                  case Bit_Depth is
                     when Eight =>
                        Scanline (P .. P + 2) :=
                          Stream_Element (Sample'Pos (Red_Sample (I, R, C))) &
                          Stream_Element (Sample'Pos (Green_Sample (I, R, C))) &
                          Stream_Element (Sample'Pos (Blue_Sample (I, R, C)));
                     when Sixteen =>
                        Scanline (P .. P + 5) :=
                          To_Buffer_2 (Unsigned_16 (Sample'Pos (Red_Sample (I, R, C)))) &
