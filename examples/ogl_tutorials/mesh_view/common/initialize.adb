...
procedure Initialize (Main_Window  : in out Glfw.Windows.Window'Class;
    ...
    -- Cursor        : Glfw.Input.Mouse.Cursor_Mode := Glfw.Input.Mouse.Hidden;   -- LCB: mouse cursor is invisible
    Cursor        : Glfw.Input.Mouse.Cursor_Mode := Glfw.Input.Mouse.Normal;  -- LCB: mouse cursor visible
begin
    Set_Window_Hints;
    ...
    -- Utilities.Show_GL_Data;  -- LCB: silence is golden
