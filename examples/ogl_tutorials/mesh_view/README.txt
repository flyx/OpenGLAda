...
The code reads only very basic Wavefront .obj files (allowing for only the simplest
...
1) Compile and run
   ...
   cd OpenGLAda-0.5/examples/ogl_tutorials/mesh_view
   make
...
The code requires OpenGLAda-0.4 or later.
