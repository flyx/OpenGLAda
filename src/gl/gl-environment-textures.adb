...
package body GL.Environment.Textures is
   ...
   begin
      API.Tex_Env_Float (Enums.Textures.Texture_Env,
                         Enums.Textures.RGB_Scale, Low_Level.Single (Value));
      Check_OpenGL_Error;
   end Set_RGB_Scale;
   ...
   begin
      API.Tex_Env_Float (Enums.Textures.Texture_Env,
                         Enums.Textures.Alpha_Scale, Low_Level.Single (Value));
      Check_OpenGL_Error;
   end Set_Alpha_Scale;
   ...
   procedure Set_LoD_Bias (Value : Real) is
   begin
      API.Tex_Env_Float (Enums.Textures.Filter_Control,
                         Enums.Textures.LoD_Bias, Low_Level.Single (Value));
      Check_OpenGL_Error;
   end Set_LoD_Bias;
