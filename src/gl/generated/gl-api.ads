...
private package GL.API is
   ...
   type T95 is access procedure (P1 : UInt; P2 : UInt; P3 : Objects.Textures.Mipmap_Level; P4 : Boolean; P5 : Int; P6 : GL.Objects.Access_Kind; P7 : Pixels.Internal_Format);
   pragma Convention (StdCall, T95);
   type T96 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4 : Size; P5 : Low_Level.Zero; P6 : Size; P7 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T96);
   type T97 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3, P4 : Int; P5, P6 : Size; P7 : Pixels.Data_Format; P8 : Pixels.Data_Type; P9 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T97);
   type T98 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4 : Size);
   pragma Convention (StdCall, T98);
   type T99 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5 : Size; P6 : Low_Level.Zero; P7 : Size; P8 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T99);
   type T100 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T100);
   type T101 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Pixels.Data_Format; P9 : Pixels.Data_Type; P10 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T101);
   type T102 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Size; P9 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T102);
   type T103 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size);
   pragma Convention (StdCall, T103);
   type T104 is access procedure (P1 : Int);
   pragma Convention (StdCall, T104);
   type T105 is access procedure (P1 : Low_Level.Enums.Texture_Kind);
   pragma Convention (StdCall, T105);
   type T106 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T106);
   type T107 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level; P3, P4, P5 : Int; P6, P7, P8 : Size);
   pragma Convention (StdCall, T107);
   type T108 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T108);
   type T109 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T109);
   type T110 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T110);
   type T111 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : UInt; P3 : UInt);
   pragma Convention (StdCall, T111);
   type T112 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.SizeIPtr; P3 : System.Address; P4 : Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T112);
   type T113 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Pixels.Internal_Format; P3 : UInt);
   pragma Convention (StdCall, T113);
   type T114 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Objects.Access_Kind) return System.Address;
   pragma Convention (StdCall, T114);
   type T115 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : Low_Level.Bitfield) return System.Address;
   pragma Convention (StdCall, T115);
   type T116 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Pointer_Param; P3 : out System.Address);
   pragma Convention (StdCall, T116);
   type T117 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : System.Address);
   pragma Convention (StdCall, T117);
   type T118 is access procedure (P1 : Low_Level.Enums.Buffer_Kind);
   pragma Convention (StdCall, T118);
   type T119 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Access_Kind);
   pragma Convention (StdCall, T119);
   type T120 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T120);
   type T121 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Size);
   pragma Convention (StdCall, T121);
   type T122 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T122);
   type T123 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T123);
   type T124 is access procedure (P1 : UInt; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr);
   pragma Convention (StdCall, T124);
   type T125 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T125);
   type T126 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T126);
   type T127 is access procedure (P1 : UInt);
   ...
   type T130 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Pixels.Internal_Format; P3, P4 : Size);
   pragma Convention (StdCall, T130);
   type T131 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T131);
   type T132 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T132);
   type T133 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Int);
   pragma Convention (StdCall, T133);
   type T134 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Pixels.Internal_Format);
   pragma Convention (StdCall, T134);
   type T135 is access procedure (P1 : Enums.Clamp_Color_Param; P2 : Low_Level.Bool);
   pragma Convention (StdCall, T135);
   type T136 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T136);
   type T137 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T137);
   type T138 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T138);
   type T139 is access function (P1 : Low_Level.Enums.Framebuffer_Kind) return Objects.Framebuffers.Framebuffer_Status;
   pragma Convention (StdCall, T139);
   type T140 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : Low_Level.Enums.Renderbuffer_Kind; P4 : UInt);
   pragma Convention (StdCall, T140);
   type T141 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T141);
   type T142 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level; P5 : Int);
   pragma Convention (StdCall, T142);
   type T143 is access procedure (P1, P2, P3, P4, P5, P6, P7, P8 : Int; P9 : Low_Level.Bitfield; P10 : Objects.Textures.Magnifying_Function);
   pragma Convention (StdCall, T143);
   type T144 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List);
   pragma Convention (StdCall, T144);
   type T145 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List; P4, P5 : Int; P6, P7 : Size);
   pragma Convention (StdCall, T145);
   type T146 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Size);
   pragma Convention (StdCall, T146);
   type T147 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Low_Level.Bool);
   pragma Convention (StdCall, T147);
   type T148 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Size);
   pragma Convention (StdCall, T148);
   type T149 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T149);
   type T150 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T150);
   type T151 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T151);
   type T152 is access function (P1 : Objects.Shaders.Shader_Type) return UInt;
   pragma Convention (StdCall, T152);
   type T153 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T153);
   type T154 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : Low_Level.Int_Array);
   ...
   type T156 is access procedure;
   pragma Convention (StdCall, T156);
   type T157 is access function return UInt;
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T158);
   type T159 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T159);
   type T160 is access procedure (P1, P2 : UInt);
   pragma Convention (StdCall, T160);
   type T161 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T161);
   type T162 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T162);
   type T163 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T163);
   type T164 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T164);
   type T165 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T165);
   type T166 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T166);
   type T167 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T167);
   type T168 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T168);
   type T169 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T169);
   type T170 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T170);
   type T171 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T171);
   type T172 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.char_array);
   pragma Convention (StdCall, T172);
   type T173 is access function (P1 : UInt; P2 : Interfaces.C.char_array) return Int;
   pragma Convention (StdCall, T173);
   type T174 is access procedure (P1 : Connection_Mode);
   pragma Convention (StdCall, T174);
   type T175 is access procedure (P1 : UInt; P2 : Int; P3 : Size; P4 : out Size; P5 : out Size; P6 : out GL.Objects.Programs.Active_Attribute; P7 : in out Interfaces.C.char_array);
   pragma Convention (StdCall, T175);
   type T176 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : GL.Objects.Programs.Buffer_Mode);
   pragma Convention (StdCall, T176);
   type T177 is access procedure (P1, P2, P3 : UInt);
   pragma Convention (StdCall, T177);
   type T178 is access procedure (P1 : Low_Level.Bitfield);
   ...
   Compressed_Tex_Image_1D : T96;
   Tex_Sub_Image_1D : T97;
   Tex_Storage_1D : T98;
   ...
   Tex_Storage_2D : T100;
   Tex_Image_3D : T101;
   Compressed_Tex_Image_3D : T102;
   Tex_Sub_Image_3D : T97;
   Tex_Storage_3D : T103;
   ...
   Active_Texture : T104;
   Generate_Mipmap : T105;
   Invalidate_Tex_Image : T106;
   Invalidate_Tex_Sub_Image : T107;
   Gen_Buffers : T108;
   Gen_Transform_Feedbacks : T108;
   Delete_Buffers : T109;
   Delete_Transform_Feedbacks : T109;
   Bind_Buffer : T110;
   Bind_Transform_Feedback : T110;
   Bind_Buffer_Base : T111;
   Buffer_Data : T112;
   Texture_Buffer_Data : T113;
   Map_Buffer : T114;
   Map_Buffer_Range : T115;
   Buffer_Pointer : T116;
   Buffer_Sub_Data : T117;
   Unmap_Buffer : T118;
   Get_Buffer_Parameter_Access_Kind : T119;
   Get_Buffer_Parameter_Bool : T120;
   Get_Buffer_Parameter_Size : T121;
   Get_Buffer_Parameter_Usage : T122;
   Invalidate_Buffer_Data : T123;
   Invalidate_Buffer_Sub_Data : T124;
   Gen_Vertex_Arrays : T125;
   Delete_Vertex_Arrays : T126;
   Bind_Vertex_Array : T127;
   Gen_Renderbuffers : T128;
   Delete_Renderbuffers : T129;
   Renderbuffer_Storage : T130;
   Renderbuffer_Storage_Multisample : T131;
   Bind_Renderbuffer : T132;
   Get_Renderbuffer_Parameter_Int : T133;
   Get_Renderbuffer_Parameter_Internal_Format : T134;
   ...
   Gen_Framebuffers : T136;
   Delete_Framebuffers : T137;
   Bind_Framebuffer : T138;
   Check_Framebuffer_Status : T139;
   Framebuffer_Renderbuffer : T140;
   Framebuffer_Texture : T141;
   Framebuffer_Texture_Layer : T142;
   Blit_Framebuffer : T143;
   Invalidate_Framebuffer : T144;
   Invalidate_Sub_Framebuffer : T145;
   Framebuffer_Parameter_Size : T146;
   Framebuffer_Parameter_Bool : T147;
   Get_Framebuffer_Parameter_Size : T148;
   Get_Framebuffer_Parameter_Bool : T149;
   Get_Shader_Param : T150;
   Get_Shader_Type : T151;
   Create_Shader : T152;
   Delete_Shader : T153;
   Shader_Source : T154;
   Get_Shader_Source : T155;
   Compile_Shader : T153;
   Release_Shader_Compiler : T156;
   Get_Shader_Info_Log : T155;
   Create_Program : T157;
   Delete_Program : T158;
   Get_Program_Param : T159;
   Attach_Shader : T160;
   Link_Program : T158;
   Get_Program_Info_Log : T161;
   Get_Program_Stage : T162;
   Get_Subroutine_Index : T163;
   Get_Subroutine_Uniform_Location : T164;
   Use_Program : T158;
   Validate_Program : T158;
   Get_Uniform_Location : T165;
   Bind_Attrib_Location : T166;
   Get_Attrib_Location : T167;
   Vertex_Attrib_Pointer : T168;
   Vertex_AttribI_Pointer : T169;
   Vertex_AttribL_Pointer : T169;
   Enable_Vertex_Attrib_Array : T170;
   Disable_Vertex_Attrib_Array : T170;
   Get_Attached_Shaders : T171;
   Bind_Frag_Data_Location : T172;
   Get_Frag_Data_Location : T173;
   Begin_Transform_Feedback : T174;
   End_Transform_Feedback : T156;
   Get_Transform_Feedback_Varying : T175;
   Transform_Feedback_Varyings : T176;
   Dispatch_Compute : T177;
   Memory_Barrier : T178;
