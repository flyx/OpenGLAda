...
private package GL.API is
   ...
   type T114 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : Low_Level.Bitfield) return System.Address;
   pragma Convention (StdCall, T114);
   type T115 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Pointer_Param; P3 : out System.Address);
   pragma Convention (StdCall, T115);
   type T116 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : System.Address);
   pragma Convention (StdCall, T116);
   type T117 is access procedure (P1 : Low_Level.Enums.Buffer_Kind);
   pragma Convention (StdCall, T117);
   type T118 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Access_Kind);
   pragma Convention (StdCall, T118);
   type T119 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T119);
   type T120 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Size);
   pragma Convention (StdCall, T120);
   type T121 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T121);
   type T122 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T122);
   type T123 is access procedure (P1 : UInt; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr);
   pragma Convention (StdCall, T123);
   type T124 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr);
   ...
   type T150 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T150);
   type T151 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T151);
   type T152 is access function (P1 : UInt) return Boolean;
   pragma Convention (StdCall, T152);
   type T153 is access procedure (P1 : UInt; P2 : Low_Level.Enums.Query_Param);
   pragma Convention (StdCall, T153);
   type T154 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T154);
   type T155 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T155);
   type T156 is access function (P1 : Objects.Shaders.Shader_Type) return UInt;
   pragma Convention (StdCall, T156);
   type T157 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : Low_Level.Int_Array);
   ...
   type T160 is access procedure;
   pragma Convention (StdCall, T160);
   type T161 is access function return UInt;
   pragma Convention (StdCall, T161);
   type T162 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T163);
   type T164 is access procedure (P1, P2 : UInt);
   pragma Convention (StdCall, T164);
   type T165 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T165);
   type T166 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T166);
   type T167 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T167);
   type T168 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T168);
   type T169 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T169);
   type T170 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T170);
   type T171 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T171);
   type T172 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T172);
   type T173 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T173);
   type T174 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T174);
   type T175 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T175);
   type T176 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.char_array);
   pragma Convention (StdCall, T176);
   type T177 is access function (P1 : UInt; P2 : Interfaces.C.char_array) return Int;
   pragma Convention (StdCall, T177);
   type T178 is access procedure (P1 : Connection_Mode);
   pragma Convention (StdCall, T178);
   type T179 is access procedure (P1 : UInt; P2 : Int; P3 : Size; P4 : out Size; P5 : out Size; P6 : out GL.Objects.Programs.Active_Attribute; P7 : in out Interfaces.C.char_array);
   pragma Convention (StdCall, T179);
   type T180 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : GL.Objects.Programs.Buffer_Mode);
   pragma Convention (StdCall, T180);
   type T181 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T181);
   type T182 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Map_Buffer : T113;
   Map_Buffer_Range : T114;
   Buffer_Pointer : T115;
   Buffer_Sub_Data : T116;
   Get_Buffer_Sub_Data : T116;
   Unmap_Buffer : T117;
   Get_Buffer_Parameter_Access_Kind : T118;
   Get_Buffer_Parameter_Bool : T119;
   Get_Buffer_Parameter_Size : T120;
   Get_Buffer_Parameter_Usage : T121;
   Invalidate_Buffer_Data : T122;
   Invalidate_Buffer_Sub_Data : T123;
   Flush_Mapped_Buffer_Range : T124;
   ...
   Delete_Queries : T151;
   Is_Query : T152;
   procedure Get_Query_Object (Query : UInt; Pname : Low_Level.Enums.Query_Results; Params : out Low_Level.UInt_Array);
   pragma Import (StdCall, Get_Query_Object, "glGetQueryObjectuiv");
   procedure Begin_Query (Target : Low_Level.Enums.Query_Param; Id : UInt);
   pragma Import (StdCall, Begin_Query, "glBeginQuery");
   procedure End_Query (Target : Low_Level.Enums.Query_Param);
   pragma Import (StdCall, End_Query, "glEndQuery");
   procedure Begin_Query_Indexed (Target : Low_Level.Enums.Query_Param; Index, Id : UInt);
   pragma Import (StdCall, Begin_Query_Indexed, "glBeginQueryIndexed");
   procedure End_Query_Indexed (Target : Low_Level.Enums.Query_Param; Index : UInt);
   pragma Import (StdCall, End_Query_Indexed, "glEndQueryIndexed");
   Query_Counter : T153;
   Get_Shader_Param : T154;
   Get_Shader_Type : T155;
   Create_Shader : T156;
   Delete_Shader : T157;
   Shader_Source : T158;
   Get_Shader_Source : T159;
   Compile_Shader : T157;
   Release_Shader_Compiler : T160;
   Get_Shader_Info_Log : T159;
   Create_Program : T161;
   Delete_Program : T162;
   Get_Program_Param : T163;
   Attach_Shader : T164;
   Link_Program : T162;
   Get_Program_Info_Log : T165;
   Get_Program_Stage : T166;
   Get_Subroutine_Index : T167;
   Get_Subroutine_Uniform_Location : T168;
   Use_Program : T162;
   Validate_Program : T162;
   Get_Uniform_Location : T169;
   Bind_Attrib_Location : T170;
   Get_Attrib_Location : T171;
   Vertex_Attrib_Pointer : T172;
   Vertex_AttribI_Pointer : T173;
   Vertex_AttribL_Pointer : T173;
   Enable_Vertex_Attrib_Array : T174;
   Disable_Vertex_Attrib_Array : T174;
   Get_Attached_Shaders : T175;
   Bind_Frag_Data_Location : T176;
   Get_Frag_Data_Location : T177;
   Begin_Transform_Feedback : T178;
   End_Transform_Feedback : T160;
   Get_Transform_Feedback_Varying : T179;
   Transform_Feedback_Varyings : T180;
   Set_Patch_Parameter_Int : T181;
   Set_Patch_Parameter_Float_Array : T182;
