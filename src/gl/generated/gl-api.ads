...
private package GL.API is
   ...
   type T179 is access procedure (P1 : Low_Level.Enums.Query_Param; P2 : UInt);
   pragma Convention (StdCall, T179);
   type T180 is access procedure (P1 : Low_Level.Enums.Query_Param);
