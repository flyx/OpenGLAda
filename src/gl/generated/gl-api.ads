...
private package GL.API is
   ...
   type T106 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.SizeIPtr; P3 : System.Address; P4 : Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T106);
   type T107 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Objects.Access_Kind) return System.Address;
   pragma Convention (StdCall, T107);
   type T108 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Pointer_Param; P3 : out System.Address);
   pragma Convention (StdCall, T108);
   type T109 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : System.Address);
   pragma Convention (StdCall, T109);
   type T110 is access procedure (P1 : Low_Level.Enums.Buffer_Kind);
   pragma Convention (StdCall, T110);
   type T111 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Access_Kind);
   pragma Convention (StdCall, T111);
   type T112 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T112);
   type T113 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Size);
   pragma Convention (StdCall, T113);
   type T114 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T114);
   type T115 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T115);
   type T116 is access procedure (P1 : UInt; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr);
   pragma Convention (StdCall, T116);
   type T117 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T117);
   type T118 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T118);
   type T119 is access procedure (P1 : UInt);
   ...
   type T122 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Pixels.Internal_Format; P3, P4 : Size);
   pragma Convention (StdCall, T122);
   type T123 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T123);
   type T124 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T124);
   type T125 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Int);
   pragma Convention (StdCall, T125);
   type T126 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Pixels.Internal_Format);
   pragma Convention (StdCall, T126);
   type T127 is access procedure (P1 : Enums.Clamp_Color_Param; P2 : Low_Level.Bool);
   pragma Convention (StdCall, T127);
   type T128 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T128);
   type T129 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T129);
   type T130 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T130);
   type T131 is access function (P1 : Low_Level.Enums.Framebuffer_Kind) return Objects.Framebuffers.Framebuffer_Status;
   pragma Convention (StdCall, T131);
   type T132 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : Low_Level.Enums.Renderbuffer_Kind; P4 : UInt);
   pragma Convention (StdCall, T132);
   type T133 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T133);
   type T134 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level; P5 : Int);
   pragma Convention (StdCall, T134);
   type T135 is access procedure (P1, P2, P3, P4, P5, P6, P7, P8 : Int; P9 : Low_Level.Bitfield; P10 : Objects.Textures.Magnifying_Function);
   pragma Convention (StdCall, T135);
   type T136 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List);
   pragma Convention (StdCall, T136);
   type T137 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List; P4, P5 : Int; P6, P7 : Size);
   pragma Convention (StdCall, T137);
   type T138 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Size);
   pragma Convention (StdCall, T138);
   type T139 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Low_Level.Bool);
   pragma Convention (StdCall, T139);
   type T140 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Size);
   pragma Convention (StdCall, T140);
   type T141 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T141);
   type T142 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T142);
   type T143 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T143);
   type T144 is access function (P1 : Objects.Shaders.Shader_Type) return UInt;
   pragma Convention (StdCall, T144);
   type T145 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T145);
   type T146 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.CharPtr_Array; P4 : Low_Level.Int_Array);
   pragma Convention (StdCall, T146);
   type T147 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T147);
   type T148 is access procedure;
   pragma Convention (StdCall, T148);
   type T149 is access function return UInt;
   pragma Convention (StdCall, T149);
   type T150 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T150);
   type T151 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T151);
   type T152 is access procedure (P1, P2 : UInt);
   ...
   type T154 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T154);
   type T155 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T155);
   type T156 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T156);
   type T157 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T158);
   type T159 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T159);
   type T160 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T160);
   type T161 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T161);
   type T162 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T163);
   type T164 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.Strings.chars_ptr);
   pragma Convention (StdCall, T164);
   type T165 is access function (P1 : UInt; P2 : Interfaces.C.Strings.chars_ptr) return Int;
   pragma Convention (StdCall, T165);
   type T166 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T166);
   type T167 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Map_Buffer : T107;
   Buffer_Pointer : T108;
   Buffer_Sub_Data : T109;
   Unmap_Buffer : T110;
   Get_Buffer_Parameter_Access_Kind : T111;
   Get_Buffer_Parameter_Bool : T112;
   Get_Buffer_Parameter_Size : T113;
   Get_Buffer_Parameter_Usage : T114;
   Invalidate_Buffer_Data : T115;
   Invalidate_Buffer_Sub_Data : T116;
   Gen_Vertex_Arrays : T117;
   Delete_Vertex_Arrays : T118;
   Bind_Vertex_Array : T119;
   Gen_Renderbuffers : T120;
   Delete_Renderbuffers : T121;
   Renderbuffer_Storage : T122;
   Renderbuffer_Storage_Multisample : T123;
   Bind_Renderbuffer : T124;
   Get_Renderbuffer_Parameter_Int : T125;
   Get_Renderbuffer_Parameter_Internal_Format : T126;
   ...
   Gen_Framebuffers : T128;
   Delete_Framebuffers : T129;
   Bind_Framebuffer : T130;
   Check_Framebuffer_Status : T131;
   Framebuffer_Renderbuffer : T132;
   Framebuffer_Texture : T133;
   Framebuffer_Texture_Layer : T134;
   Blit_Framebuffer : T135;
   Invalidate_Framebuffer : T136;
   Invalidate_Sub_Framebuffer : T137;
   Framebuffer_Parameter_Size : T138;
   Framebuffer_Parameter_Bool : T139;
   Get_Framebuffer_Parameter_Size : T140;
   Get_Framebuffer_Parameter_Bool : T141;
   Get_Shader_Param : T142;
   Get_Shader_Type : T143;
   Create_Shader : T144;
   Delete_Shader : T145;
   Shader_Source : T146;
   Get_Shader_Source : T147;
   Compile_Shader : T145;
   Release_Shader_Compiler : T148;
   Get_Shader_Info_Log : T147;
   Create_Program : T149;
   Delete_Program : T150;
   Get_Program_Param : T151;
   Attach_Shader : T152;
   Link_Program : T150;
   Get_Program_Info_Log : T153;
   Get_Program_Stage : T154;
   Get_Subroutine_Index : T155;
   Get_Subroutine_Uniform_Location : T156;
   Use_Program : T150;
   Validate_Program : T150;
   Get_Uniform_Location : T157;
   Bind_Attrib_Location : T158;
   Get_Attrib_Location : T159;
   Vertex_Attrib_Pointer : T160;
   Vertex_AttribI_Pointer : T161;
   Vertex_AttribL_Pointer : T161;
   Enable_Vertex_Attrib_Array : T162;
   Disable_Vertex_Attrib_Array : T162;
   Get_Attached_Shaders : T163;
   Bind_Frag_Data_Location : T164;
   Get_Frag_Data_Location : T165;
   Set_Patch_Parameter_Int : T166;
   Set_Patch_Parameter_Float_Array : T167;
