...
private package GL.API is
   ...
   type T167 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T167);
   type T168 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Set_Patch_Parameter_Int : T167;
   Set_Patch_Parameter_Float_Array : T168;
