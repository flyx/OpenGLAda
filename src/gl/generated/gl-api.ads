...
private package GL.API is
   ...
   type T91 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4 : Size);
   ...
   type T93 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   ...
   type T96 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5, P6 : Size);
