...
private package GL.API is
   ...
   type T90 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4 : Size; P5 : Low_Level.Zero; P6 : Size; P7 : System.Address);
   pragma Convention (StdCall, T90);
   type T91 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5 : Size; P6 : Low_Level.Zero; P7 : Size; P8 : System.Address);
   pragma Convention (StdCall, T91);
   type T92 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Pixels.Data_Format; P9 : Pixels.Data_Type; P10 : System.Address);
   pragma Convention (StdCall, T92);
   type T93 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Size; P9 : System.Address);
   pragma Convention (StdCall, T93);
   type T94 is access procedure (P1 : Int);
   pragma Convention (StdCall, T94);
   type T95 is access procedure (P1 : Low_Level.Enums.Texture_Kind);
   pragma Convention (StdCall, T95);
   type T96 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T96);
   type T97 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level; P3, P4, P5 : Int; P6, P7, P8 : Size);
   pragma Convention (StdCall, T97);
   type T98 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4 : Size);
   pragma Convention (StdCall, T98);
   type T99 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T99);
   type T100 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5, P6 : Size);
   pragma Convention (StdCall, T100);
   type T101 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T101);
   type T102 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T102);
   type T103 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T103);
   type T104 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.SizeIPtr; P3 : System.Address; P4 : Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T104);
   type T105 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Objects.Access_Kind) return System.Address;
   pragma Convention (StdCall, T105);
   type T106 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Pointer_Param; P3 : out System.Address);
   pragma Convention (StdCall, T106);
   type T107 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : System.Address);
   pragma Convention (StdCall, T107);
   type T108 is access procedure (P1 : Low_Level.Enums.Buffer_Kind);
   pragma Convention (StdCall, T108);
   type T109 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Access_Kind);
   pragma Convention (StdCall, T109);
   type T110 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T110);
   type T111 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Size);
   pragma Convention (StdCall, T111);
   type T112 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T112);
   type T113 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T113);
   type T114 is access procedure (P1 : UInt; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr);
   pragma Convention (StdCall, T114);
   type T115 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T115);
   type T116 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T116);
   type T117 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T117);
   type T118 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T118);
   type T119 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T119);
   type T120 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Pixels.Internal_Format; P3, P4 : Size);
   pragma Convention (StdCall, T120);
   type T121 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T121);
   type T122 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T122);
   type T123 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Int);
   pragma Convention (StdCall, T123);
   type T124 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Pixels.Internal_Format);
   pragma Convention (StdCall, T124);
   type T125 is access procedure (P1 : Enums.Clamp_Color_Param; P2 : Low_Level.Bool);
   ...
   type T128 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T128);
   type T129 is access function (P1 : Low_Level.Enums.Framebuffer_Kind) return Objects.Framebuffers.Framebuffer_Status;
   pragma Convention (StdCall, T129);
   type T130 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : Low_Level.Enums.Renderbuffer_Kind; P4 : UInt);
   pragma Convention (StdCall, T130);
   type T131 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T131);
   type T132 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level; P5 : Int);
   pragma Convention (StdCall, T132);
   type T133 is access procedure (P1, P2, P3, P4, P5, P6, P7, P8 : Int; P9 : Low_Level.Bitfield; P10 : Objects.Textures.Magnifying_Function);
   pragma Convention (StdCall, T133);
   type T134 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List);
   pragma Convention (StdCall, T134);
   type T135 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List; P4, P5 : Int; P6, P7 : Size);
   pragma Convention (StdCall, T135);
   type T136 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Size);
   pragma Convention (StdCall, T136);
   type T137 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Low_Level.Bool);
   pragma Convention (StdCall, T137);
   type T138 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Size);
   pragma Convention (StdCall, T138);
   type T139 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T139);
   type T140 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T140);
   type T141 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T141);
   type T142 is access function (P1 : Objects.Shaders.Shader_Type) return Uint;
   pragma Convention (StdCall, T142);
   type T143 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T143);
   type T144 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.CharPtr_Array; P4 : Low_Level.Int_Array);
   pragma Convention (StdCall, T144);
   type T145 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T145);
   type T146 is access procedure;
   pragma Convention (StdCall, T146);
   type T147 is access function return UInt;
   pragma Convention (StdCall, T147);
   type T148 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T148);
   type T149 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T149);
   type T150 is access procedure (P1, P2 : UInt);
   pragma Convention (StdCall, T150);
   type T151 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T151);
   type T152 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T152);
   type T153 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T153);
   type T154 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T154);
   type T155 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T155);
   type T156 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T156);
   type T157 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T158);
   type T159 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T159);
   type T160 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T160);
   type T161 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T161);
   type T162 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   procedure Tex_Image_1D (Target : Low_Level.Enums.Texture_Kind; Level : Objects.Textures.Mipmap_Level; Internal_Format : Pixels.Internal_Format; Width : Size; Border : Low_Level.Zero; Format : Pixels.Data_Format; Data_Type : Pixels.Data_Type; Data : System.Address);
   pragma Import (StdCall, Tex_Image_1D, "glTexImage1D");
   Compressed_Tex_Image_1D : T90;
   procedure Tex_Image_2D (Target : Low_Level.Enums.Texture_Kind; Level : Objects.Textures.Mipmap_Level; Internal_Format : Pixels.Internal_Format; Width, Height : Size; Border : Low_Level.Zero; Format : Pixels.Data_Format; Data_Type : Pixels.Data_Type; Data : System.Address);
   pragma Import (StdCall, Tex_Image_2D, "glTexImage2D");
   Compressed_Tex_Image_2D : T91;
   Tex_Image_3D : T92;
   Compressed_Tex_Image_3D : T93;
   ...
   Active_Texture : T94;
   Generate_Mipmap : T95;
   Invalidate_Tex_Image : T96;
   Invalidate_Tex_Sub_Image : T97;
   Tex_Storage_1D : T98;
   Tex_Storage_2D : T99;
   Tex_Storage_3D : T100;
   Gen_Buffers : T101;
   ...
   Map_Buffer : T105;
   Buffer_Pointer : T106;
   Buffer_Sub_Data : T107;
   Unmap_Buffer : T108;
   Get_Buffer_Parameter_Access_Kind : T109;
   Get_Buffer_Parameter_Bool : T110;
   Get_Buffer_Parameter_Size : T111;
   Get_Buffer_Parameter_Usage : T112;
   Invalidate_Buffer_Data : T113;
   Invalidate_Buffer_Sub_Data : T114;
   Gen_Vertex_Arrays : T115;
   Delete_Vertex_Arrays : T116;
   Bind_Vertex_Array : T117;
   Gen_Renderbuffers : T118;
   Delete_Renderbuffers : T119;
   Renderbuffer_Storage : T120;
   Renderbuffer_Storage_Multisample : T121;
   Bind_Renderbuffer : T122;
   Get_Renderbuffer_Parameter_Int : T123;
   Get_Renderbuffer_Parameter_Internal_Format : T124;
   ...
   Gen_Framebuffers : T126;
   Delete_Framebuffers : T127;
   Bind_Framebuffer : T128;
   Check_Framebuffer_Status : T129;
   Framebuffer_Renderbuffer : T130;
   Framebuffer_Texture : T131;
   Framebuffer_Texture_Layer : T132;
   Blit_Framebuffer : T133;
   Invalidate_Framebuffer : T134;
   Invalidate_Sub_Framebuffer : T135;
   Framebuffer_Parameter_Size : T136;
   Framebuffer_Parameter_Bool : T137;
   Get_Framebuffer_Parameter_Size : T138;
   Get_Framebuffer_Parameter_Bool : T139;
   Get_Shader_Param : T140;
   Get_Shader_Type : T141;
   Create_Shader : T142;
   Delete_Shader : T143;
   Shader_Source : T144;
   Get_Shader_Source : T145;
   Compile_Shader : T143;
   Release_Shader_Compiler : T146;
   Get_Shader_Info_Log : T145;
   Create_Program : T147;
   Delete_Program : T148;
   Get_Program_Param : T149;
   Attach_Shader : T150;
   Link_Program : T148;
   Get_Program_Info_Log : T151;
   Get_Program_Stage : T152;
   Get_Subroutine_Index : T153;
   Get_Subroutine_Uniform_Location : T154;
   Use_Program : T148;
   Validate_Program : T148;
   Get_Uniform_Location : T155;
   Bind_Attrib_Location : T156;
   Get_Attrib_Location : T157;
   Vertex_Attrib_Pointer : T158;
   Vertex_AttribI_Pointer : T159;
   Vertex_AttribL_Pointer : T159;
   Enable_Vertex_Attrib_Array : T160;
   Disable_Vertex_Attrib_Array : T160;
   Get_Attached_Shaders : T161;
   Set_Patch_Parameter_Int : T162;
   Set_Patch_Parameter_Float_Array : T163;
