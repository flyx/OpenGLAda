...
private package GL.API is
   ...
   type T124 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T124);
   type T125 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T125);
   type T126 is access procedure (P1 : UInt);
   ...
   type T129 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Pixels.Internal_Format; P3, P4 : Size);
   pragma Convention (StdCall, T129);
   type T130 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T130);
   type T131 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T131);
   type T132 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Int);
   pragma Convention (StdCall, T132);
   type T133 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Pixels.Internal_Format);
   pragma Convention (StdCall, T133);
   type T134 is access procedure (P1 : Enums.Clamp_Color_Param; P2 : Low_Level.Bool);
   pragma Convention (StdCall, T134);
   type T135 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T135);
   type T136 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T136);
   type T137 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T137);
   type T138 is access function (P1 : Low_Level.Enums.Framebuffer_Kind) return Objects.Framebuffers.Framebuffer_Status;
   pragma Convention (StdCall, T138);
   type T139 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : Low_Level.Enums.Renderbuffer_Kind; P4 : UInt);
   pragma Convention (StdCall, T139);
   type T140 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T140);
   type T141 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level; P5 : Int);
   pragma Convention (StdCall, T141);
   type T142 is access procedure (P1, P2, P3, P4, P5, P6, P7, P8 : Int; P9 : Low_Level.Bitfield; P10 : Objects.Textures.Magnifying_Function);
   pragma Convention (StdCall, T142);
   type T143 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List);
   pragma Convention (StdCall, T143);
   type T144 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List; P4, P5 : Int; P6, P7 : Size);
   pragma Convention (StdCall, T144);
   type T145 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Size);
   pragma Convention (StdCall, T145);
   type T146 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Low_Level.Bool);
   pragma Convention (StdCall, T146);
   type T147 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Size);
   pragma Convention (StdCall, T147);
   type T148 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T148);
   type T149 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T149);
   type T150 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T150);
   type T151 is access function (P1 : Objects.Shaders.Shader_Type) return UInt;
   pragma Convention (StdCall, T151);
   type T152 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T152);
   type T153 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : Low_Level.Int_Array);
   ...
   type T155 is access procedure;
   pragma Convention (StdCall, T155);
   type T156 is access function return UInt;
   pragma Convention (StdCall, T156);
   type T157 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T158);
   type T159 is access procedure (P1, P2 : UInt);
   ...
   type T161 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T161);
   type T162 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T162);
   type T163 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T163);
   type T164 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T164);
   type T165 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T165);
   type T166 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T166);
   type T167 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T167);
   type T168 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T168);
   type T169 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T169);
   type T170 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T170);
   type T171 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.char_array);
   pragma Convention (StdCall, T171);
   type T172 is access function (P1 : UInt; P2 : Interfaces.C.char_array) return Int;
   pragma Convention (StdCall, T172);
   type T173 is access procedure (P1 : Connection_Mode);
   pragma Convention (StdCall, T173);
   type T174 is access procedure (P1 : UInt; P2 : Int; P3 : Size; P4 : out Size; P5 : out Size; P6 : out GL.Objects.Programs.Active_Attribute; P7 : in out Interfaces.C.char_array);
   pragma Convention (StdCall, T174);
   type T175 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : GL.Objects.Programs.Buffer_Mode);
   pragma Convention (StdCall, T175);
   type T176 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T176);
   type T177 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Gen_Vertex_Arrays : T124;
   Delete_Vertex_Arrays : T125;
   Bind_Vertex_Array : T126;
   Gen_Renderbuffers : T127;
   Delete_Renderbuffers : T128;
   Renderbuffer_Storage : T129;
   Renderbuffer_Storage_Multisample : T130;
   Bind_Renderbuffer : T131;
   Get_Renderbuffer_Parameter_Int : T132;
   Get_Renderbuffer_Parameter_Internal_Format : T133;
   ...
   Gen_Framebuffers : T135;
   Delete_Framebuffers : T136;
   Bind_Framebuffer : T137;
   Check_Framebuffer_Status : T138;
   Framebuffer_Renderbuffer : T139;
   Framebuffer_Texture : T140;
   Framebuffer_Texture_Layer : T141;
   Blit_Framebuffer : T142;
   Invalidate_Framebuffer : T143;
   Invalidate_Sub_Framebuffer : T144;
   Framebuffer_Parameter_Size : T145;
   Framebuffer_Parameter_Bool : T146;
   Get_Framebuffer_Parameter_Size : T147;
   Get_Framebuffer_Parameter_Bool : T148;
   Get_Shader_Param : T149;
   Get_Shader_Type : T150;
   Create_Shader : T151;
   Delete_Shader : T152;
   Shader_Source : T153;
   Get_Shader_Source : T154;
   Compile_Shader : T152;
   Release_Shader_Compiler : T155;
   Get_Shader_Info_Log : T154;
   Create_Program : T156;
   Delete_Program : T157;
   Get_Program_Param : T158;
   Attach_Shader : T159;
   Link_Program : T157;
   Get_Program_Info_Log : T160;
   Get_Program_Stage : T161;
   Get_Subroutine_Index : T162;
   Get_Subroutine_Uniform_Location : T163;
   Use_Program : T157;
   Validate_Program : T157;
   Get_Uniform_Location : T164;
   Bind_Attrib_Location : T165;
   Get_Attrib_Location : T166;
   Vertex_Attrib_Pointer : T167;
   Vertex_AttribI_Pointer : T168;
   Vertex_AttribL_Pointer : T168;
   Enable_Vertex_Attrib_Array : T169;
   Disable_Vertex_Attrib_Array : T169;
   Get_Attached_Shaders : T170;
   Bind_Frag_Data_Location : T171;
   Get_Frag_Data_Location : T172;
   Begin_Transform_Feedback : T173;
