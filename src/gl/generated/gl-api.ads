...
private package GL.API is
   ...
   type T74 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3 : Blending.Blend_Factor);
   pragma Convention (StdCall, T74);
   type T75 is access procedure (P1, P2, P3, P4 : Blending.Blend_Factor);
   pragma Convention (StdCall, T75);
   type T76 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3, P4, P5 : Blending.Blend_Factor);
   pragma Convention (StdCall, T76);
   type T77 is access procedure (P1, P2, P3, P4 : Colors.Component);
   pragma Convention (StdCall, T77);
   type T78 is access procedure (P1 : Blending.Equation);
   pragma Convention (StdCall, T78);
   type T79 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2 : Blending.Equation);
   pragma Convention (StdCall, T79);
   type T80 is access procedure (P1, P2 : Blending.Equation);
   pragma Convention (StdCall, T80);
   type T81 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3 : Blending.Equation);
   pragma Convention (StdCall, T81);
   type T82 is access procedure (P1 : Enums.Point_Param; P2 : Single);
   pragma Convention (StdCall, T82);
   type T83 is access procedure (P1 : UInt; P2 : Buffers.Explicit_Color_Buffer_List);
   pragma Convention (StdCall, T83);
   type T84 is access procedure (P1 : Buffers.Color_Buffer_Selector; P2 : Low_Level.Zero; P3 : Colors.Color);
   pragma Convention (StdCall, T84);
   type T85 is access procedure (P1 : Low_Level.Enums.Only_Color_Buffer; P2 : Buffers.Draw_Buffer_Index; P3 : Colors.Color);
   pragma Convention (StdCall, T85);
   type T86 is access procedure (P1 : Low_Level.Enums.Only_Depth_Buffer; P2 : Low_Level.Zero; P3 : access constant Buffers.Depth);
   pragma Convention (StdCall, T86);
   type T87 is access procedure (P1 : Low_Level.Enums.Only_Stencil_Buffer; P2 : Low_Level.Zero; P3 : access constant Buffers.Stencil_Index);
   pragma Convention (StdCall, T87);
   type T88 is access procedure (P1 : Low_Level.Enums.Only_Depth_Stencil_Buffer; P2 : Low_Level.Zero; P3 : Buffers.Depth; P4 : Buffers.Stencil_Index);
   pragma Convention (StdCall, T88);
   type T89 is access procedure (P1 : Culling.Face_Selector; P2 : Compare_Function; P3 : Int; P4 : UInt);
   pragma Convention (StdCall, T89);
   type T90 is access procedure (P1 : Culling.Face_Selector; P2, P3, P4 : Buffers.Stencil_Action);
   pragma Convention (StdCall, T90);
   type T91 is access procedure (P1 : Culling.Face_Selector; P2 : UInt);
   pragma Convention (StdCall, T91);
   type T92 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4 : Size; P5 : Low_Level.Zero; P6 : Size; P7 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T92);
   type T93 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3, P4 : Int; P5, P6 : Size; P7 : Pixels.Data_Format; P8 : Pixels.Data_Type; P9 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T93);
   type T94 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4 : Size);
   pragma Convention (StdCall, T94);
   type T95 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5 : Size; P6 : Low_Level.Zero; P7 : Size; P8 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T95);
   type T96 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T96);
   type T97 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Pixels.Data_Format; P9 : Pixels.Data_Type; P10 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T97);
   type T98 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Size; P9 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T98);
   type T99 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size);
   pragma Convention (StdCall, T99);
   type T100 is access procedure (P1 : Int);
   pragma Convention (StdCall, T100);
   type T101 is access procedure (P1 : Low_Level.Enums.Texture_Kind);
   pragma Convention (StdCall, T101);
   type T102 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T102);
   type T103 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level; P3, P4, P5 : Int; P6, P7, P8 : Size);
   pragma Convention (StdCall, T103);
   type T104 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T104);
   type T105 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T105);
   type T106 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T106);
   type T107 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : UInt; P3 : UInt);
   pragma Convention (StdCall, T107);
   type T108 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.SizeIPtr; P3 : System.Address; P4 : Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T108);
   type T109 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Pixels.Internal_Format; P3 : UInt);
   pragma Convention (StdCall, T109);
   type T110 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Objects.Access_Kind) return System.Address;
   pragma Convention (StdCall, T110);
   type T111 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Pointer_Param; P3 : out System.Address);
   pragma Convention (StdCall, T111);
   type T112 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : System.Address);
   pragma Convention (StdCall, T112);
   type T113 is access procedure (P1 : Low_Level.Enums.Buffer_Kind);
   pragma Convention (StdCall, T113);
   type T114 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Access_Kind);
   pragma Convention (StdCall, T114);
   type T115 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T115);
   type T116 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Size);
   pragma Convention (StdCall, T116);
   type T117 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Buffers.Buffer_Usage);
   ...
   type T125 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Pixels.Internal_Format; P3, P4 : Size);
   pragma Convention (StdCall, T125);
   type T126 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T126);
   type T127 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T127);
   type T128 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Int);
   pragma Convention (StdCall, T128);
   type T129 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Pixels.Internal_Format);
   pragma Convention (StdCall, T129);
   type T130 is access procedure (P1 : Enums.Clamp_Color_Param; P2 : Low_Level.Bool);
   pragma Convention (StdCall, T130);
   type T131 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T131);
   type T132 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T132);
   type T133 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T133);
   type T134 is access function (P1 : Low_Level.Enums.Framebuffer_Kind) return Objects.Framebuffers.Framebuffer_Status;
   pragma Convention (StdCall, T134);
   type T135 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : Low_Level.Enums.Renderbuffer_Kind; P4 : UInt);
   pragma Convention (StdCall, T135);
   type T136 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T136);
   type T137 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level; P5 : Int);
   pragma Convention (StdCall, T137);
   type T138 is access procedure (P1, P2, P3, P4, P5, P6, P7, P8 : Int; P9 : Low_Level.Bitfield; P10 : Objects.Textures.Magnifying_Function);
   pragma Convention (StdCall, T138);
   type T139 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List);
   pragma Convention (StdCall, T139);
   type T140 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List; P4, P5 : Int; P6, P7 : Size);
   pragma Convention (StdCall, T140);
   type T141 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Size);
   pragma Convention (StdCall, T141);
   type T142 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Low_Level.Bool);
   pragma Convention (StdCall, T142);
   type T143 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Size);
   pragma Convention (StdCall, T143);
   type T144 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T144);
   type T145 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T145);
   type T146 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T146);
   type T147 is access function (P1 : Objects.Shaders.Shader_Type) return UInt;
   ...
   type T151 is access procedure;
   pragma Convention (StdCall, T151);
   type T152 is access function return UInt;
   pragma Convention (StdCall, T152);
   type T153 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T153);
   type T154 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T154);
   type T155 is access procedure (P1, P2 : UInt);
   pragma Convention (StdCall, T155);
   type T156 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T156);
   type T157 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T157);
   type T158 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T158);
   type T159 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T159);
   type T160 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T160);
   type T161 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T161);
   type T162 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T163);
   type T164 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T164);
   type T165 is access procedure (P1 : Attributes.Attribute);
   ...
   type T170 is access procedure (P1 : UInt; P2 : Int; P3 : Size; P4 : out Size; P5 : out Size; P6 : out GL.Objects.Programs.Buffer_Mode; P7 : in out Interfaces.C.char_array);
   ...
   type T173 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Blend_Func_I : T74;
   Blend_Func_Separate : T75;
   Blend_Func_Separate_I : T76;
   Blend_Color : T77;
   Blend_Equation : T78;
   Blend_Equation_I : T79;
   Blend_Equation_Separate : T80;
   Blend_Equation_Separate_I : T81;
   ...
   Set_Point_Parameter_Single : T82;
   ...
   Clear_Accum : T77;
   Clear_Buffer : T84;
   Clear_Draw_Buffer : T85;
   Clear_Buffer_Depth : T86;
   Clear_Buffer_Stencil : T87;
   Clear_Buffer_Depth_Stencil : T88;
   ...
   Stencil_Func_Separate : T89;
   Stencil_Op_Separate : T90;
   Stencil_Mask_Separate : T91;
   ...
   Compressed_Tex_Image_1D : T92;
   Tex_Sub_Image_1D : T93;
   Tex_Storage_1D : T94;
   ...
   Tex_Storage_2D : T96;
   Tex_Image_3D : T97;
   Compressed_Tex_Image_3D : T98;
   Tex_Sub_Image_3D : T93;
   Tex_Storage_3D : T99;
   ...
   Gen_Framebuffers : T131;
   Delete_Framebuffers : T132;
   Bind_Framebuffer : T133;
   Check_Framebuffer_Status : T134;
   Framebuffer_Renderbuffer : T135;
   Framebuffer_Texture : T136;
   Framebuffer_Texture_Layer : T137;
   Blit_Framebuffer : T138;
   Invalidate_Framebuffer : T139;
   Invalidate_Sub_Framebuffer : T140;
   Framebuffer_Parameter_Size : T141;
   Framebuffer_Parameter_Bool : T142;
   Get_Framebuffer_Parameter_Size : T143;
   Get_Framebuffer_Parameter_Bool : T144;
   Get_Shader_Param : T145;
   Get_Shader_Type : T146;
   Create_Shader : T147;
   Delete_Shader : T148;
   Shader_Source : T149;
   Get_Shader_Source : T150;
   Compile_Shader : T148;
   Release_Shader_Compiler : T151;
   Get_Shader_Info_Log : T150;
   Create_Program : T152;
   Delete_Program : T153;
   Get_Program_Param : T154;
   Attach_Shader : T155;
   Link_Program : T153;
   Get_Program_Info_Log : T156;
   Get_Program_Stage : T157;
   Get_Subroutine_Index : T158;
   Get_Subroutine_Uniform_Location : T159;
   Use_Program : T153;
   Validate_Program : T153;
   Get_Uniform_Location : T160;
   Bind_Attrib_Location : T161;
   Get_Attrib_Location : T162;
   Vertex_Attrib_Pointer : T163;
   Vertex_AttribI_Pointer : T164;
   Vertex_AttribL_Pointer : T164;
   Enable_Vertex_Attrib_Array : T165;
   Disable_Vertex_Attrib_Array : T165;
   Get_Attached_Shaders : T166;
   ...
   Set_Patch_Parameter_Float_Array : T173;
