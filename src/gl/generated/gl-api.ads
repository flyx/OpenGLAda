...
private package GL.API is
   ...
   type T177 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T177);
   type T178 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Set_Patch_Parameter_Int : T177;
   Set_Patch_Parameter_Float_Array : T178;
