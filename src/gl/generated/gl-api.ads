...
private package GL.API is
   ...
   type T144 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : Low_Level.Enums.Texture_Kind; P4 : UInt; P5 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T144);
   type T145 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level; P5 : Int);
   pragma Convention (StdCall, T145);
   type T146 is access procedure (P1, P2, P3, P4, P5, P6, P7, P8 : Int; P9 : Low_Level.Bitfield; P10 : Objects.Textures.Magnifying_Function);
   pragma Convention (StdCall, T146);
   type T147 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List);
   pragma Convention (StdCall, T147);
   type T148 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List; P4, P5 : Int; P6, P7 : Size);
   pragma Convention (StdCall, T148);
   type T149 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Size);
   pragma Convention (StdCall, T149);
   type T150 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Low_Level.Bool);
   pragma Convention (StdCall, T150);
   type T151 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Size);
   pragma Convention (StdCall, T151);
   type T152 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T152);
   type T153 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T153);
   type T154 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T154);
   type T155 is access function (P1 : UInt) return Boolean;
   pragma Convention (StdCall, T155);
   type T156 is access procedure (P1 : UInt; P2 : Low_Level.Enums.Query_Results; P3 : out UInt);
   pragma Convention (StdCall, T156);
   type T157 is access procedure (P1 : Low_Level.Enums.Query_Param; P2 : UInt);
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : Low_Level.Enums.Query_Param);
   pragma Convention (StdCall, T158);
   type T159 is access procedure (P1 : Low_Level.Enums.Query_Param; P2, P3 : UInt);
   pragma Convention (StdCall, T159);
   type T160 is access procedure (P1 : Low_Level.Enums.Query_Param; P2 : UInt);
   pragma Convention (StdCall, T160);
   type T161 is access procedure (P1 : UInt; P2 : Low_Level.Enums.Query_Param);
   pragma Convention (StdCall, T161);
   type T162 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T163);
   type T164 is access function (P1 : Objects.Shaders.Shader_Type) return UInt;
   pragma Convention (StdCall, T164);
   type T165 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T165);
   type T166 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : Low_Level.Int_Array);
   pragma Convention (StdCall, T166);
   type T167 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T167);
   type T168 is access procedure;
   pragma Convention (StdCall, T168);
   type T169 is access function return UInt;
   pragma Convention (StdCall, T169);
   type T170 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T170);
   type T171 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T171);
   type T172 is access procedure (P1, P2 : UInt);
   ...
   type T174 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T174);
   type T175 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T175);
   type T176 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T176);
   type T177 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T177);
   type T178 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T178);
   type T179 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T179);
   type T180 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T180);
   type T181 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T181);
   type T182 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T182);
   type T183 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T183);
   type T184 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.char_array);
   pragma Convention (StdCall, T184);
   type T185 is access function (P1 : UInt; P2 : Interfaces.C.char_array) return Int;
   pragma Convention (StdCall, T185);
   type T186 is access procedure (P1 : Connection_Mode);
   pragma Convention (StdCall, T186);
   type T187 is access procedure (P1 : UInt; P2 : Int; P3 : Size; P4 : out Size; P5 : out Size; P6 : out GL.Objects.Programs.Active_Attribute; P7 : in out Interfaces.C.char_array);
   pragma Convention (StdCall, T187);
   type T188 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : GL.Objects.Programs.Buffer_Mode);
   pragma Convention (StdCall, T188);
   type T189 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T189);
   type T190 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Framebuffer_Texture_2D : T144;
   Framebuffer_Texture_Layer : T145;
   Blit_Framebuffer : T146;
   Invalidate_Framebuffer : T147;
   Invalidate_Sub_Framebuffer : T148;
   Framebuffer_Parameter_Size : T149;
   Framebuffer_Parameter_Bool : T150;
   Get_Framebuffer_Parameter_Size : T151;
   Get_Framebuffer_Parameter_Bool : T152;
   Gen_Queries : T153;
   Delete_Queries : T154;
   Is_Query : T155;
   Get_Query_Object : T156;
   Begin_Query : T157;
   End_Query : T158;
   Begin_Query_Indexed : T159;
   End_Query_Indexed : T160;
   Query_Counter : T161;
   Get_Shader_Param : T162;
   Get_Shader_Type : T163;
   Create_Shader : T164;
   Delete_Shader : T165;
   Shader_Source : T166;
   Get_Shader_Source : T167;
   Compile_Shader : T165;
   Release_Shader_Compiler : T168;
   Get_Shader_Info_Log : T167;
   Create_Program : T169;
   Delete_Program : T170;
   Get_Program_Param : T171;
   Attach_Shader : T172;
   Link_Program : T170;
   Get_Program_Info_Log : T173;
   Get_Program_Stage : T174;
   Get_Subroutine_Index : T175;
   Get_Subroutine_Uniform_Location : T176;
   Use_Program : T170;
   Validate_Program : T170;
   Get_Uniform_Location : T177;
   Bind_Attrib_Location : T178;
   Get_Attrib_Location : T179;
   Vertex_Attrib_Pointer : T180;
   Vertex_AttribI_Pointer : T181;
   Vertex_AttribL_Pointer : T181;
   Enable_Vertex_Attrib_Array : T182;
   Disable_Vertex_Attrib_Array : T182;
   Get_Attached_Shaders : T183;
   Bind_Frag_Data_Location : T184;
   Get_Frag_Data_Location : T185;
   Begin_Transform_Feedback : T186;
   End_Transform_Feedback : T168;
   Get_Transform_Feedback_Varying : T187;
   Transform_Feedback_Varyings : T188;
   Set_Patch_Parameter_Int : T189;
   Set_Patch_Parameter_Float_Array : T190;
