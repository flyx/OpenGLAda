...
private package GL.API is
   ...
   type T152 is access procedure (P1 : UInt; P2 : Low_Level.Enums.Query_Results; P3 : out Int);
   pragma Convention (StdCall, T152);
   type T153 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T153);
   type T154 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T154);
   type T155 is access function (P1 : Objects.Shaders.Shader_Type) return UInt;
   pragma Convention (StdCall, T155);
   type T156 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T156);
   type T157 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : Low_Level.Int_Array);
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T158);
   type T159 is access procedure;
   pragma Convention (StdCall, T159);
   type T160 is access function return UInt;
   pragma Convention (StdCall, T160);
   type T161 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T161);
   type T162 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1, P2 : UInt);
   pragma Convention (StdCall, T163);
   type T164 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T164);
   type T165 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T165);
   type T166 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T166);
   type T167 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T167);
   type T168 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T168);
   type T169 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T169);
   type T170 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T170);
   type T171 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T171);
   type T172 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T172);
   type T173 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T173);
   type T174 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T174);
   type T175 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.char_array);
   pragma Convention (StdCall, T175);
   type T176 is access function (P1 : UInt; P2 : Interfaces.C.char_array) return Int;
   pragma Convention (StdCall, T176);
   type T177 is access procedure (P1 : Connection_Mode);
   pragma Convention (StdCall, T177);
   type T178 is access procedure (P1 : UInt; P2 : Int; P3 : Size; P4 : out Size; P5 : out Size; P6 : out GL.Objects.Programs.Active_Attribute; P7 : in out Interfaces.C.char_array);
   pragma Convention (StdCall, T178);
   type T179 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : GL.Objects.Programs.Buffer_Mode);
   pragma Convention (StdCall, T179);
   type T180 is access procedure (P1 : Low_Level.Enums.Query_Param; P2 : UInt);
   pragma Convention (StdCall, T180);
   type T181 is access procedure (P1 : Low_Level.Enums.Query_Param);
   pragma Convention (StdCall, T181);
   type T182 is access procedure (P1 : Low_Level.Enums.Query_Param; P2, P3 : UInt);
   pragma Convention (StdCall, T182);
   type T183 is access procedure (P1 : Low_Level.Enums.Query_Param; P2 : UInt);
   pragma Convention (StdCall, T183);
   type T184 is access procedure (P1 : UInt; P2 : Low_Level.Enums.Query_Param);
   pragma Convention (StdCall, T184);
   type T185 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T185);
   type T186 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Gen_Queries : T150;
   Delete_Queries : T151;
   Get_Query_Object : T152;
   Get_Shader_Param : T153;
   Get_Shader_Type : T154;
   Create_Shader : T155;
   Delete_Shader : T156;
   Shader_Source : T157;
   Get_Shader_Source : T158;
   Compile_Shader : T156;
   Release_Shader_Compiler : T159;
   Get_Shader_Info_Log : T158;
   Create_Program : T160;
   Delete_Program : T161;
   Get_Program_Param : T162;
   Attach_Shader : T163;
   Link_Program : T161;
   Get_Program_Info_Log : T164;
   Get_Program_Stage : T165;
   Get_Subroutine_Index : T166;
   Get_Subroutine_Uniform_Location : T167;
   Use_Program : T161;
   Validate_Program : T161;
   Get_Uniform_Location : T168;
   Bind_Attrib_Location : T169;
   Get_Attrib_Location : T170;
   Vertex_Attrib_Pointer : T171;
   Vertex_AttribI_Pointer : T172;
   Vertex_AttribL_Pointer : T172;
   Enable_Vertex_Attrib_Array : T173;
   Disable_Vertex_Attrib_Array : T173;
   Get_Attached_Shaders : T174;
   Bind_Frag_Data_Location : T175;
   Get_Frag_Data_Location : T176;
   Begin_Transform_Feedback : T177;
   End_Transform_Feedback : T159;
   Get_Transform_Feedback_Varying : T178;
   Transform_Feedback_Varyings : T179;
   Begin_Query : T180;
   End_Query : T181;
   Begin_Query_Indexed : T182;
   End_Query_Indexed : T183;
   Query_Counter : T184;
   Set_Patch_Parameter_Int : T185;
   Set_Patch_Parameter_Float_Array : T186;
