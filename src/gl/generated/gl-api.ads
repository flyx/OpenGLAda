...
private package GL.API is
   ...
   type T153 is access procedure (P1 : UInt; P2 : Low_Level.Enums.Query_Results; P3 : out UInt);
   pragma Convention (StdCall, T153);
   type T154 is access procedure (P1 : UInt; P2 : Low_Level.Enums.Query_Param);
   pragma Convention (StdCall, T154);
   type T155 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T155);
   type T156 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T156);
   type T157 is access function (P1 : Objects.Shaders.Shader_Type) return UInt;
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T158);
   type T159 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : Low_Level.Int_Array);
   pragma Convention (StdCall, T159);
   type T160 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T160);
   type T161 is access procedure;
   pragma Convention (StdCall, T161);
   type T162 is access function return UInt;
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T163);
   type T164 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T164);
   type T165 is access procedure (P1, P2 : UInt);
   ...
   type T167 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T167);
   type T168 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T168);
   type T169 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T169);
   type T170 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T170);
   type T171 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T171);
   type T172 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T172);
   type T173 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T173);
   type T174 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T174);
   type T175 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T175);
   type T176 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T176);
   type T177 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.char_array);
   pragma Convention (StdCall, T177);
   type T178 is access function (P1 : UInt; P2 : Interfaces.C.char_array) return Int;
   pragma Convention (StdCall, T178);
   type T179 is access procedure (P1 : Connection_Mode);
   pragma Convention (StdCall, T179);
   type T180 is access procedure (P1 : UInt; P2 : Int; P3 : Size; P4 : out Size; P5 : out Size; P6 : out GL.Objects.Programs.Active_Attribute; P7 : in out Interfaces.C.char_array);
   pragma Convention (StdCall, T180);
   type T181 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : GL.Objects.Programs.Buffer_Mode);
   pragma Convention (StdCall, T181);
   type T182 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T182);
   type T183 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   ...
   Query_Counter : T154;
   Get_Shader_Param : T155;
   Get_Shader_Type : T156;
   Create_Shader : T157;
   Delete_Shader : T158;
   Shader_Source : T159;
   Get_Shader_Source : T160;
   Compile_Shader : T158;
   Release_Shader_Compiler : T161;
   Get_Shader_Info_Log : T160;
   Create_Program : T162;
   Delete_Program : T163;
   Get_Program_Param : T164;
   Attach_Shader : T165;
   Link_Program : T163;
   Get_Program_Info_Log : T166;
   Get_Program_Stage : T167;
   Get_Subroutine_Index : T168;
   Get_Subroutine_Uniform_Location : T169;
   Use_Program : T163;
   Validate_Program : T163;
   Get_Uniform_Location : T170;
   Bind_Attrib_Location : T171;
   Get_Attrib_Location : T172;
   Vertex_Attrib_Pointer : T173;
   Vertex_AttribI_Pointer : T174;
   Vertex_AttribL_Pointer : T174;
   Enable_Vertex_Attrib_Array : T175;
   Disable_Vertex_Attrib_Array : T175;
   Get_Attached_Shaders : T176;
   Bind_Frag_Data_Location : T177;
   Get_Frag_Data_Location : T178;
   Begin_Transform_Feedback : T179;
   End_Transform_Feedback : T161;
   Get_Transform_Feedback_Varying : T180;
   Transform_Feedback_Varyings : T181;
   Set_Patch_Parameter_Int : T182;
   Set_Patch_Parameter_Float_Array : T183;
