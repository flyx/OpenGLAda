...
private package GL.API is
   pragma Preelaborate;
   use GL.Types;
   type T1 is access function (P1 : Enums.Getter.String_Parameter; P2 : Uint) return C.Strings.chars_ptr;
   pragma Convention (StdCall, T1);
   type T2 is access procedure (P1 : Colors.Color);
   pragma Convention (StdCall, T2);
   type T3 is access procedure (P1 : Double);
   pragma Convention (StdCall, T3);
   type T4 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3 : Blending.Blend_Factor);
   pragma Convention (StdCall, T4);
   type T5 is access procedure (P1, P2, P3, P4 : Blending.Blend_Factor);
   pragma Convention (StdCall, T5);
   type T6 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3, P4, P5 : Blending.Blend_Factor);
   pragma Convention (StdCall, T6);
   type T7 is access procedure (P1, P2, P3, P4 : Colors.Component);
   pragma Convention (StdCall, T7);
   type T8 is access procedure (P1 : Blending.Equation);
   pragma Convention (StdCall, T8);
   type T9 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2 : Blending.Equation);
   pragma Convention (StdCall, T9);
   type T10 is access procedure (P1, P2 : Blending.Equation);
   pragma Convention (StdCall, T10);
   type T11 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3 : Blending.Equation);
   pragma Convention (StdCall, T11);
   type T12 is access procedure (P1 : Enums.Point_Param; P2 : Single);
   pragma Convention (StdCall, T12);
   type T13 is access procedure (P1 : UInt; P2 : Buffers.Explicit_Color_Buffer_List);
   pragma Convention (StdCall, T13);
   type T14 is access procedure (P1 : Buffers.Color_Buffer_Selector; P2 : Low_Level.Zero; P3 : Colors.Color);
   pragma Convention (StdCall, T14);
   type T15 is access procedure (P1 : Low_Level.Enums.Only_Color_Buffer; P2 : Buffers.Draw_Buffer_Index; P3 : Colors.Color);
   pragma Convention (StdCall, T15);
   type T16 is access procedure (P1 : Low_Level.Enums.Only_Depth_Buffer; P2 : Low_Level.Zero; P3 : access constant Buffers.Depth);
   pragma Convention (StdCall, T16);
   type T17 is access procedure (P1 : Low_Level.Enums.Only_Stencil_Buffer; P2 : Low_Level.Zero; P3 : access constant Buffers.Stencil_Index);
   pragma Convention (StdCall, T17);
   type T18 is access procedure (P1 : Low_Level.Enums.Only_Depth_Stencil_Buffer; P2 : Low_Level.Zero; P3 : Buffers.Depth; P4 : Buffers.Stencil_Index);
   pragma Convention (StdCall, T18);
   type T19 is access procedure (P1 : Culling.Face_Selector; P2 : Compare_Function; P3 : Int; P4 : UInt);
   pragma Convention (StdCall, T19);
   type T20 is access procedure (P1 : Culling.Face_Selector; P2, P3, P4 : Buffers.Stencil_Action);
   pragma Convention (StdCall, T20);
   type T21 is access procedure (P1 : Culling.Face_Selector; P2 : UInt);
   pragma Convention (StdCall, T21);
   type T22 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4 : Size; P5 : Low_Level.Zero; P6 : Size; P7 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T22);
   type T23 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4 : Size);
   pragma Convention (StdCall, T23);
   type T24 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5 : Size; P6 : Low_Level.Zero; P7 : Size; P8 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T24);
   type T25 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T25);
   type T26 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Pixels.Data_Format; P9 : Pixels.Data_Type; P10 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T26);
   type T27 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Size; P9 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T27);
   type T28 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5, P6 : Size);
   pragma Convention (StdCall, T28);
   type T29 is access procedure (P1 : Int);
   pragma Convention (StdCall, T29);
   type T30 is access procedure (P1 : Low_Level.Enums.Texture_Kind);
   pragma Convention (StdCall, T30);
   type T31 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T31);
   type T32 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level; P3, P4, P5 : Int; P6, P7, P8 : Size);
   pragma Convention (StdCall, T32);
   type T33 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T33);
   type T34 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T34);
   type T35 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T35);
   type T36 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.SizeIPtr; P3 : System.Address; P4 : Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T36);
   type T37 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Objects.Access_Kind) return System.Address;
   pragma Convention (StdCall, T37);
   type T38 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Pointer_Param; P3 : out System.Address);
   pragma Convention (StdCall, T38);
   type T39 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : System.Address);
   pragma Convention (StdCall, T39);
   type T40 is access procedure (P1 : Low_Level.Enums.Buffer_Kind);
   pragma Convention (StdCall, T40);
   type T41 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Access_Kind);
   pragma Convention (StdCall, T41);
   type T42 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T42);
   type T43 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Size);
   pragma Convention (StdCall, T43);
   type T44 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T44);
   type T45 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T45);
   type T46 is access procedure (P1 : UInt; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr);
   pragma Convention (StdCall, T46);
   type T47 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T47);
   type T48 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T48);
   type T49 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T49);
   type T50 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T50);
   type T51 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T51);
   type T52 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Pixels.Internal_Format; P3, P4 : Size);
   pragma Convention (StdCall, T52);
   type T53 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T53);
   type T54 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T54);
   type T55 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Int);
   pragma Convention (StdCall, T55);
   type T56 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Pixels.Internal_Format);
   pragma Convention (StdCall, T56);
   type T57 is access procedure (P1 : Enums.Clamp_Color_Param; P2 : Low_Level.Bool);
   pragma Convention (StdCall, T57);
   type T58 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T58);
   type T59 is access procedure (P1 : Size; P2 : Low_Level.UInt_Array);
   pragma Convention (StdCall, T59);
   type T60 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T60);
   type T61 is access function (P1 : Low_Level.Enums.Framebuffer_Kind) return Objects.Framebuffers.Framebuffer_Status;
   pragma Convention (StdCall, T61);
   type T62 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : Low_Level.Enums.Renderbuffer_Kind; P4 : UInt);
   pragma Convention (StdCall, T62);
   type T63 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T63);
   type T64 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level; P5 : Int);
   pragma Convention (StdCall, T64);
   type T65 is access procedure (P1, P2, P3, P4, P5, P6, P7, P8 : Int; P9 : Low_Level.Bitfield; P10 : Objects.Textures.Magnifying_Function);
   pragma Convention (StdCall, T65);
   type T66 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List);
   pragma Convention (StdCall, T66);
   type T67 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List; P4, P5 : Int; P6, P7 : Size);
   pragma Convention (StdCall, T67);
   type T68 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Size);
   pragma Convention (StdCall, T68);
   type T69 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Low_Level.Bool);
   pragma Convention (StdCall, T69);
   type T70 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Size);
   pragma Convention (StdCall, T70);
   type T71 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T71);
   type T72 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T72);
   type T73 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T73);
   type T74 is access function (P1 : Objects.Shaders.Shader_Type) return Uint;
   pragma Convention (StdCall, T74);
   type T75 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T75);
   type T76 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.CharPtr_Array; P4 : Low_Level.Int_Array);
   pragma Convention (StdCall, T76);
   type T77 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T77);
   type T78 is access procedure;
   pragma Convention (StdCall, T78);
   type T79 is access function return UInt;
   pragma Convention (StdCall, T79);
   type T80 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T80);
   type T81 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T81);
   type T82 is access procedure (P1, P2 : UInt);
   pragma Convention (StdCall, T82);
   type T83 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T83);
   type T84 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T84);
   type T85 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T85);
   type T86 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T86);
   type T87 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T87);
   type T88 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T88);
   type T89 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T89);
   type T90 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T90);
   type T91 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T91);
   type T92 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T92);
   type T93 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T93);
   type T94 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.Strings.chars_ptr);
   pragma Convention (StdCall, T94);
   type T95 is access function (P1 : UInt; P2 : Interfaces.C.Strings.chars_ptr) return Int;
   pragma Convention (StdCall, T95);
   type T96 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T96);
   type T97 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Types.Single_Array);
   pragma Convention (StdCall, T97);
   type T98 is access procedure (P1 : Uniforms.Uniform; P2 : UInt);
   pragma Convention (StdCall, T98);
   type T99 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : UInt_Array);
   pragma Convention (StdCall, T99);
   type T100 is access procedure (P1 : Uniforms.Uniform; P2, P3 : UInt);
   pragma Convention (StdCall, T100);
   type T101 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Uints.Vector2_Array);
   pragma Convention (StdCall, T101);
   type T102 is access procedure (P1 : Uniforms.Uniform; P2, P3, P4 : UInt);
   pragma Convention (StdCall, T102);
   type T103 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Uints.Vector3_Array);
   pragma Convention (StdCall, T103);
   type T104 is access procedure (P1 : Uniforms.Uniform; P2, P3, P4, P5 : UInt);
   pragma Convention (StdCall, T104);
   type T105 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Uints.Vector4_Array);
   pragma Convention (StdCall, T105);
   type T106 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Low_Level.Bool; P4 : Uints.Matrix2_Array);
   pragma Convention (StdCall, T106);
   type T107 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Low_Level.Bool; P4 : Uints.Matrix3_Array);
   pragma Convention (StdCall, T107);
   type T108 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Low_Level.Bool; P4 : Uints.Matrix4_Array);
   pragma Convention (StdCall, T108);
   type T109 is access procedure (P1 : Attributes.Attribute; P2 : UInt);
   pragma Convention (StdCall, T109);
   type T110 is access procedure (P1 : Attributes.Attribute; P2, P3 : UInt);
   pragma Convention (StdCall, T110);
   type T111 is access procedure (P1 : Attributes.Attribute; P2 : Uints.Vector2);
   pragma Convention (StdCall, T111);
   type T112 is access procedure (P1 : Attributes.Attribute; P2, P3, P4 : UInt);
   pragma Convention (StdCall, T112);
   type T113 is access procedure (P1 : Attributes.Attribute; P2 : Uints.Vector3);
   pragma Convention (StdCall, T113);
   type T114 is access procedure (P1 : Attributes.Attribute; P2, P3, P4, P5 : UInt);
   pragma Convention (StdCall, T114);
   type T115 is access procedure (P1 : Attributes.Attribute; P2 : Uints.Vector4);
   pragma Convention (StdCall, T115);
   type T116 is access procedure (P1 : Uniforms.Uniform; P2 : Single);
   pragma Convention (StdCall, T116);
   type T117 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Single_Array);
   pragma Convention (StdCall, T117);
   type T118 is access procedure (P1 : Uniforms.Uniform; P2, P3 : Single);
   pragma Convention (StdCall, T118);
   type T119 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Types.Singles.Vector2_Array);
   pragma Convention (StdCall, T119);
   type T120 is access procedure (P1 : Uniforms.Uniform; P2, P3, P4 : Single);
   pragma Convention (StdCall, T120);
   type T121 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Types.Singles.Vector3_Array);
   pragma Convention (StdCall, T121);
   type T122 is access procedure (P1 : Uniforms.Uniform; P2, P3, P4, P5 : Single);
   pragma Convention (StdCall, T122);
   type T123 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Types.Singles.Vector4_Array);
   pragma Convention (StdCall, T123);
   type T124 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Low_Level.Bool; P4 : Types.Singles.Matrix2_Array);
   pragma Convention (StdCall, T124);
   type T125 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Low_Level.Bool; P4 : Types.Singles.Matrix3_Array);
   pragma Convention (StdCall, T125);
   type T126 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Low_Level.Bool; P4 : Types.Singles.Matrix4_Array);
   pragma Convention (StdCall, T126);
   type T127 is access procedure (P1 : Attributes.Attribute; P2 : Single);
   pragma Convention (StdCall, T127);
   type T128 is access procedure (P1 : Attributes.Attribute; P2, P3 : Single);
   pragma Convention (StdCall, T128);
   type T129 is access procedure (P1 : Attributes.Attribute; P2 : Types.Singles.Vector2);
   pragma Convention (StdCall, T129);
   type T130 is access procedure (P1 : Attributes.Attribute; P2, P3, P4 : Single);
   pragma Convention (StdCall, T130);
   type T131 is access procedure (P1 : Attributes.Attribute; P2 : Types.Singles.Vector3);
   pragma Convention (StdCall, T131);
   type T132 is access procedure (P1 : Attributes.Attribute; P2, P3, P4, P5 : Single);
   pragma Convention (StdCall, T132);
   type T133 is access procedure (P1 : Attributes.Attribute; P2 : Types.Singles.Vector4);
   pragma Convention (StdCall, T133);
   type T134 is access procedure (P1 : Attributes.Attribute; P2 : Double);
   pragma Convention (StdCall, T134);
   type T135 is access procedure (P1 : Attributes.Attribute; P2, P3 : Double);
   pragma Convention (StdCall, T135);
   type T136 is access procedure (P1 : Attributes.Attribute; P2 : Types.Doubles.Vector2);
   pragma Convention (StdCall, T136);
   type T137 is access procedure (P1 : Attributes.Attribute; P2, P3, P4 : Double);
   pragma Convention (StdCall, T137);
   type T138 is access procedure (P1 : Attributes.Attribute; P2 : Types.Doubles.Vector3);
   pragma Convention (StdCall, T138);
   type T139 is access procedure (P1 : Attributes.Attribute; P2, P3, P4, P5 : Double);
   pragma Convention (StdCall, T139);
   type T140 is access procedure (P1 : Attributes.Attribute; P2 : Types.Doubles.Vector4);
   pragma Convention (StdCall, T140);
   type T141 is access procedure (P1 : Attributes.Attribute; P2 : Short);
   pragma Convention (StdCall, T141);
   type T142 is access procedure (P1 : Attributes.Attribute; P2, P3 : Short);
   pragma Convention (StdCall, T142);
   type T143 is access procedure (P1 : Attributes.Attribute; P2 : Shorts.Vector2);
   pragma Convention (StdCall, T143);
   type T144 is access procedure (P1 : Attributes.Attribute; P2, P3, P4 : Short);
   pragma Convention (StdCall, T144);
   type T145 is access procedure (P1 : Attributes.Attribute; P2 : Shorts.Vector3);
   pragma Convention (StdCall, T145);
   type T146 is access procedure (P1 : Attributes.Attribute; P2, P3, P4, P5 : Short);
   pragma Convention (StdCall, T146);
   type T147 is access procedure (P1 : Attributes.Attribute; P2 : Shorts.Vector4);
   pragma Convention (StdCall, T147);
   type T148 is access procedure (P1 : Uniforms.Uniform; P2 : Int);
   pragma Convention (StdCall, T148);
   type T149 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Int_Array);
   pragma Convention (StdCall, T149);
   type T150 is access procedure (P1 : Uniforms.Uniform; P2, P3 : Int);
   pragma Convention (StdCall, T150);
   type T151 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Types.Ints.Vector2_Array);
   pragma Convention (StdCall, T151);
   type T152 is access procedure (P1 : Uniforms.Uniform; P2, P3, P4 : Int);
   pragma Convention (StdCall, T152);
   type T153 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Types.Ints.Vector3_Array);
   pragma Convention (StdCall, T153);
   type T154 is access procedure (P1 : Uniforms.Uniform; P2, P3, P4, P5 : Int);
   pragma Convention (StdCall, T154);
   type T155 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Types.Ints.Vector4_Array);
   pragma Convention (StdCall, T155);
   type T156 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Low_Level.Bool; P4 : Types.Ints.Matrix2_Array);
   pragma Convention (StdCall, T156);
   type T157 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Low_Level.Bool; P4 : Types.Ints.Matrix3_Array);
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : Uniforms.Uniform; P2 : Size; P3 : Low_Level.Bool; P4 : Types.Ints.Matrix4_Array);
   pragma Convention (StdCall, T158);
   type T159 is access procedure (P1 : Attributes.Attribute; P2 : Int);
   pragma Convention (StdCall, T159);
   type T160 is access procedure (P1 : Attributes.Attribute; P2, P3 : Int);
   pragma Convention (StdCall, T160);
   type T161 is access procedure (P1 : Attributes.Attribute; P2 : Types.Ints.Vector2);
   pragma Convention (StdCall, T161);
   type T162 is access procedure (P1 : Attributes.Attribute; P2, P3, P4 : Int);
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1 : Attributes.Attribute; P2 : Types.Ints.Vector3);
   pragma Convention (StdCall, T163);
   type T164 is access procedure (P1 : Attributes.Attribute; P2, P3, P4, P5 : Int);
   pragma Convention (StdCall, T164);
   type T165 is access procedure (P1 : Attributes.Attribute; P2 : Types.Ints.Vector4);
   ...
   Blend_Func_I : T4;
   Blend_Func_Separate : T5;
   Blend_Func_Separate_I : T6;
   Blend_Color : T7;
   Blend_Equation : T8;
   Blend_Equation_I : T9;
   Blend_Equation_Separate : T10;
   Blend_Equation_Separate_I : T11;
   ...
   Set_Point_Parameter_Single : T12;
   ...
   Clear_Accum : T7;
   Clear_Buffer : T14;
   Clear_Draw_Buffer : T15;
   Clear_Buffer_Depth : T16;
   Clear_Buffer_Stencil : T17;
   Clear_Buffer_Depth_Stencil : T18;
   ...
   Stencil_Func_Separate : T19;
   Stencil_Op_Separate : T20;
   Stencil_Mask_Separate : T21;
   ...
   Active_Texture : T29;
   Generate_Mipmap : T30;
   Invalidate_Tex_Image : T31;
   Invalidate_Tex_Sub_Image : T32;
   Gen_Buffers : T33;
   Delete_Buffers : T34;
   Bind_Buffer : T35;
   Buffer_Data : T36;
   ...
   Buffer_Sub_Data : T39;
   Unmap_Buffer : T40;
   Get_Buffer_Parameter_Access_Kind : T41;
   Get_Buffer_Parameter_Bool : T42;
   Get_Buffer_Parameter_Size : T43;
   Get_Buffer_Parameter_Usage : T44;
   Invalidate_Buffer_Data : T45;
   Invalidate_Buffer_Sub_Data : T46;
   Gen_Vertex_Arrays : T47;
   Delete_Vertex_Arrays : T48;
   Bind_Vertex_Array : T49;
   Gen_Renderbuffers : T50;
   Delete_Renderbuffers : T51;
   Renderbuffer_Storage : T52;
   Renderbuffer_Storage_Multisample : T53;
   Bind_Renderbuffer : T54;
   Get_Renderbuffer_Parameter_Int : T55;
   Get_Renderbuffer_Parameter_Internal_Format : T56;
   ...
   Gen_Framebuffers : T58;
   Delete_Framebuffers : T59;
   Bind_Framebuffer : T60;
   Check_Framebuffer_Status : T61;
   Framebuffer_Renderbuffer : T62;
   Framebuffer_Texture : T63;
   Framebuffer_Texture_Layer : T64;
   Blit_Framebuffer : T65;
   Invalidate_Framebuffer : T66;
   Invalidate_Sub_Framebuffer : T67;
   Framebuffer_Parameter_Size : T68;
   Framebuffer_Parameter_Bool : T69;
   Get_Framebuffer_Parameter_Size : T70;
   Get_Framebuffer_Parameter_Bool : T71;
   Get_Shader_Param : T72;
   Get_Shader_Type : T73;
   Create_Shader : T74;
   Delete_Shader : T75;
   Shader_Source : T76;
   Get_Shader_Source : T77;
   Compile_Shader : T75;
   Release_Shader_Compiler : T78;
   Get_Shader_Info_Log : T77;
   Create_Program : T79;
   Delete_Program : T80;
   Get_Program_Param : T81;
   Attach_Shader : T82;
   Link_Program : T80;
   Get_Program_Info_Log : T83;
   Get_Program_Stage : T84;
   Get_Subroutine_Index : T85;
   Get_Subroutine_Uniform_Location : T86;
   Use_Program : T80;
   Validate_Program : T80;
   Get_Uniform_Location : T87;
   Bind_Attrib_Location : T88;
   Get_Attrib_Location : T89;
   Vertex_Attrib_Pointer : T90;
   Vertex_AttribI_Pointer : T91;
   Vertex_AttribL_Pointer : T91;
   Enable_Vertex_Attrib_Array : T92;
   Disable_Vertex_Attrib_Array : T92;
   Get_Attached_Shaders : T93;
   Bind_Frag_Data_Location : T94;
   Get_Frag_Data_Location : T95;
   Set_Patch_Parameter_Int : T96;
   Set_Patch_Parameter_Float_Array : T97;
