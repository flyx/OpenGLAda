...
private package GL.API is
   ...
   Active_Texture : T100;
   Generate_Mipmap : T101;
   Invalidate_Tex_Image : T102;
   Invalidate_Tex_Sub_Image : T103;
   Gen_Buffers : T104;
   Delete_Buffers : T105;
   Bind_Buffer : T106;
   ...
   Map_Buffer : T110;
   Buffer_Pointer : T111;
   Buffer_Sub_Data : T112;
   Unmap_Buffer : T113;
   Get_Buffer_Parameter_Access_Kind : T114;
   Get_Buffer_Parameter_Bool : T115;
   Get_Buffer_Parameter_Size : T116;
   Get_Buffer_Parameter_Usage : T117;
   Invalidate_Buffer_Data : T118;
   Invalidate_Buffer_Sub_Data : T119;
   Gen_Vertex_Arrays : T120;
   Delete_Vertex_Arrays : T121;
   Bind_Vertex_Array : T122;
   Gen_Renderbuffers : T123;
   Delete_Renderbuffers : T124;
   Renderbuffer_Storage : T125;
   Renderbuffer_Storage_Multisample : T126;
   Bind_Renderbuffer : T127;
   Get_Renderbuffer_Parameter_Int : T128;
   Get_Renderbuffer_Parameter_Internal_Format : T129;
