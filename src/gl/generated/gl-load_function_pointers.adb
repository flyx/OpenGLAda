...
begin
   ...
   GL.API.Blend_Func_I := Load_T73 ("glBlendFunci");
   GL.API.Blend_Func_Separate := Load_T74 ("glBlendFuncSeparate");
   GL.API.Blend_Func_Separate_I := Load_T75 ("glBlendFuncSeparate");
   GL.API.Blend_Color := Load_T76 ("glBlendColor");
   GL.API.Blend_Equation := Load_T77 ("glBlendEquation");
   GL.API.Blend_Equation_I := Load_T78 ("glBlendEquationi");
   GL.API.Blend_Equation_Separate := Load_T79 ("glBlendEquationSeparate");
   GL.API.Blend_Equation_Separate_I := Load_T80 ("glBlendEquationi");
   GL.API.Set_Point_Parameter_Single := Load_T81 ("glPointParameterf");
   GL.API.Draw_Buffers := Load_T82 ("glDrawBuffers");
   GL.API.Clear_Accum := Load_T76 ("glClearAccum");
   GL.API.Clear_Buffer := Load_T83 ("glClearBufferfv");
   GL.API.Clear_Draw_Buffer := Load_T84 ("glClearBufferfv");
   GL.API.Clear_Buffer_Depth := Load_T85 ("glClearBufferfv");
   GL.API.Clear_Buffer_Stencil := Load_T86 ("glClearBufferiv");
   GL.API.Clear_Buffer_Depth_Stencil := Load_T87 ("glClearBufferfi");
   GL.API.Stencil_Func_Separate := Load_T88 ("glStencilFuncSeparate");
   GL.API.Stencil_Op_Separate := Load_T89 ("glStencilOpSeparate");
   GL.API.Stencil_Mask_Separate := Load_T90 ("glStencilMaskSeparate");
   GL.API.Compressed_Tex_Image_1D := Load_T91 ("glCompressedTexImage1D");
   GL.API.Tex_Sub_Image_1D := Load_T92 ("glTexSubImage1D");
   GL.API.Tex_Storage_1D := Load_T93 ("glTexStorage1D");
   GL.API.Compressed_Tex_Image_2D := Load_T94 ("glCompressedTexImage2D");
   GL.API.Tex_Storage_2D := Load_T95 ("glTexStorage2D");
   GL.API.Tex_Image_3D := Load_T96 ("glTexImage3D");
   GL.API.Compressed_Tex_Image_3D := Load_T97 ("glCompressedTexImage3D");
   GL.API.Tex_Sub_Image_3D := Load_T92 ("glTexSubImage3D");
   GL.API.Tex_Storage_3D := Load_T98 ("glTexStorage3D");
   GL.API.Active_Texture := Load_T99 ("glActiveTexture");
   GL.API.Generate_Mipmap := Load_T100 ("glGenerateMipmap");
   GL.API.Invalidate_Tex_Image := Load_T101 ("glInvalidateTexImage");
   GL.API.Invalidate_Tex_Sub_Image := Load_T102 ("glInvalidateTexSubImage");
   GL.API.Gen_Buffers := Load_T103 ("glGenBuffers");
   GL.API.Delete_Buffers := Load_T104 ("glDeleteBuffers");
   GL.API.Bind_Buffer := Load_T105 ("glBindBuffer");
   GL.API.Bind_Buffer_Base := Load_T106 ("glBindBufferBase");
   GL.API.Buffer_Data := Load_T107 ("glBufferData");
   GL.API.Texture_Buffer_Allocate := Load_T107 ("glBufferData");
   GL.API.Texture_Buffer_Data := Load_T108 ("glTexBuffer");
   GL.API.Map_Buffer := Load_T109 ("glMapBuffer");
   GL.API.Buffer_Pointer := Load_T110 ("glGetBufferPointerv");
   GL.API.Buffer_Sub_Data := Load_T111 ("glBufferSubData");
   GL.API.Unmap_Buffer := Load_T112 ("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T113 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T114 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T115 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T116 ("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T117 ("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T118 ("glInvalidateBufferSubData");
   GL.API.Gen_Vertex_Arrays := Load_T119 ("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T120 ("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T121 ("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T122 ("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T123 ("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T124 ("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T125 ("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T126 ("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T127 ("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T128 ("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T129 ("glClampColor");
   GL.API.Gen_Framebuffers := Load_T130 ("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T131 ("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T132 ("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T133 ("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T134 ("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T135 ("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T136 ("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T137 ("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T138 ("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T139 ("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T140 ("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T141 ("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T142 ("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T143 ("glGetFramebufferParameteriv");
   GL.API.Get_Shader_Param := Load_T144 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T145 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T146 ("glCreateShader");
   GL.API.Delete_Shader := Load_T147 ("glDeleteShader");
   GL.API.Shader_Source := Load_T148 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T149 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T147 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T150 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T149 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T151 ("glCreateProgram");
   GL.API.Delete_Program := Load_T152 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T153 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T154 ("glAttachShader");
   GL.API.Link_Program := Load_T152 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T155 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T156 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T157 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T158 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T152 ("glUseProgram");
   GL.API.Validate_Program := Load_T152 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T159 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T160 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T161 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T162 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T163 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T163 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T164 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T164 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T165 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T166 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T167 ("glGetFragDataLocation");
   GL.API.Begin_Transform_Feedback := Load_T168 ("glBeginTransformFeedback");
   GL.API.Get_Transform_Feedback_Varying := Load_T169 ("glGetTransformFeedbackVarying");
   GL.API.Transform_Feedback_Varyings := Load_T170 ("glTransformFeedbackVaryings");
   GL.API.Set_Patch_Parameter_Int := Load_T171 ("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T172 ("glPatchParameterfv");
