...
begin
   ...
   GL.API.Tex_Storage_1D := Load_T91("glTexStorage1D");
   GL.API.Compressed_Tex_Image_2D := Load_T92("glCompressedTexImage2D");
   GL.API.Tex_Storage_2D := Load_T93("glTexStorage2D");
   GL.API.Tex_Image_3D := Load_T94("glTexImage3D");
   GL.API.Compressed_Tex_Image_3D := Load_T95("glCompressedTexImage3D");
   GL.API.Tex_Storage_3D := Load_T96("glTexStorage3D");
   GL.API.Active_Texture := Load_T97("glActiveTexture");
   GL.API.Generate_Mipmap := Load_T98("glGenerateMipmap");
   GL.API.Invalidate_Tex_Image := Load_T99("glInvalidateTexImage");
   GL.API.Invalidate_Tex_Sub_Image := Load_T100("glInvalidateTexSubImage");
   GL.API.Gen_Buffers := Load_T101("glGenBuffers");
   GL.API.Delete_Buffers := Load_T102("glDeleteBuffers");
   GL.API.Bind_Buffer := Load_T103("glBindBuffer");
   GL.API.Buffer_Data := Load_T104("glBufferData");
   GL.API.Map_Buffer := Load_T105("glMapBuffer");
   GL.API.Buffer_Pointer := Load_T106("glGetBufferPointerv");
   GL.API.Buffer_Sub_Data := Load_T107("glBufferSubData");
   GL.API.Unmap_Buffer := Load_T108("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T109("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T110("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T111("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T112("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T113("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T114("glInvalidateBufferSubData");
   GL.API.Gen_Vertex_Arrays := Load_T115("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T116("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T117("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T118("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T119("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T120("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T121("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T122("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T123("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T124("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T125("glClampColor");
   GL.API.Gen_Framebuffers := Load_T126("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T127("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T128("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T129("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T130("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T131("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T132("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T133("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T134("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T135("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T136("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T137("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T138("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T139("glGetFramebufferParameteriv");
   GL.API.Get_Shader_Param := Load_T140("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T141("glGetShaderiv");
   GL.API.Create_Shader := Load_T142("glCreateShader");
   GL.API.Delete_Shader := Load_T143("glDeleteShader");
   GL.API.Shader_Source := Load_T144("glShaderSource");
   GL.API.Get_Shader_Source := Load_T145("glGetShaderSource");
   GL.API.Compile_Shader := Load_T143("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T146("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T145("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T147("glCreateProgram");
   GL.API.Delete_Program := Load_T148("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T149("glGetProgramiv");
   GL.API.Attach_Shader := Load_T150("glAttachShader");
   GL.API.Link_Program := Load_T148("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T151("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T152("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T153("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T154("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T148("glUseProgram");
   GL.API.Validate_Program := Load_T148("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T155("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T156("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T157("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T158("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T159("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T159("glVertexAttribLPointer");
