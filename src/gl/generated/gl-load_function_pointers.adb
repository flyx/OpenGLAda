...
begin
   ...
   GL.API.Bind_Buffer_Base := Load_T105 ("glBindBufferBase");
   GL.API.Buffer_Data := Load_T106 ("glBufferData");
   GL.API.Texture_Buffer_Allocate := Load_T106 ("glBufferData");
   GL.API.Texture_Buffer_Data := Load_T107 ("glTexBuffer");
   GL.API.Map_Buffer := Load_T108 ("glMapBuffer");
   GL.API.Buffer_Pointer := Load_T109 ("glGetBufferPointerv");
   GL.API.Buffer_Sub_Data := Load_T110 ("glBufferSubData");
   GL.API.Unmap_Buffer := Load_T111 ("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T112 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T113 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T114 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T115 ("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T116 ("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T117 ("glInvalidateBufferSubData");
   GL.API.Gen_Vertex_Arrays := Load_T118 ("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T119 ("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T120 ("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T121 ("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T122 ("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T123 ("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T124 ("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T125 ("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T126 ("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T127 ("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T128 ("glClampColor");
   GL.API.Gen_Framebuffers := Load_T129 ("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T130 ("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T131 ("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T132 ("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T133 ("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T134 ("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T135 ("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T136 ("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T137 ("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T138 ("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T139 ("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T140 ("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T141 ("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T142 ("glGetFramebufferParameteriv");
   GL.API.Get_Shader_Param := Load_T143 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T144 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T145 ("glCreateShader");
   GL.API.Delete_Shader := Load_T146 ("glDeleteShader");
   GL.API.Shader_Source := Load_T147 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T148 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T146 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T149 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T148 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T150 ("glCreateProgram");
   GL.API.Delete_Program := Load_T151 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T152 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T153 ("glAttachShader");
   GL.API.Link_Program := Load_T151 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T154 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T155 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T156 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T157 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T151 ("glUseProgram");
   GL.API.Validate_Program := Load_T151 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T158 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T159 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T160 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T161 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T162 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T162 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T163 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T163 ("glDisableVertexAttribArray");
