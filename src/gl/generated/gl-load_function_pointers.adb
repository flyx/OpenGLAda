...
begin
   ...
   GL.API.Gen_Vertex_Arrays := Load_T124 ("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T125 ("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T126 ("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T127 ("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T128 ("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T129 ("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T130 ("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T131 ("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T132 ("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T133 ("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T134 ("glClampColor");
   GL.API.Gen_Framebuffers := Load_T135 ("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T136 ("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T137 ("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T138 ("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T139 ("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T140 ("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T141 ("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T142 ("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T143 ("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T144 ("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T145 ("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T146 ("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T147 ("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T148 ("glGetFramebufferParameteriv");
   GL.API.Get_Shader_Param := Load_T149 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T150 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T151 ("glCreateShader");
   GL.API.Delete_Shader := Load_T152 ("glDeleteShader");
   GL.API.Shader_Source := Load_T153 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T154 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T152 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T155 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T154 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T156 ("glCreateProgram");
   GL.API.Delete_Program := Load_T157 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T158 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T159 ("glAttachShader");
   GL.API.Link_Program := Load_T157 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T160 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T161 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T162 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T163 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T157 ("glUseProgram");
   GL.API.Validate_Program := Load_T157 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T164 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T165 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T166 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T167 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T168 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T168 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T169 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T169 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T170 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T171 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T172 ("glGetFragDataLocation");
   GL.API.Begin_Transform_Feedback := Load_T173 ("glBeginTransformFeedback");
   GL.API.End_Transform_Feedback := Load_T155 ("glEndTransformFeedback");
   GL.API.Get_Transform_Feedback_Varying := Load_T174 ("glGetTransformFeedbackVarying");
   GL.API.Transform_Feedback_Varyings := Load_T175 ("glTransformFeedbackVaryings");
   GL.API.Set_Patch_Parameter_Int := Load_T176 ("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T177 ("glPatchParameterfv");
