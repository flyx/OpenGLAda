...
begin
   ...
   GL.API.Unmap_Buffer := Load_T117 ("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T118 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T119 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T120 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T121 ("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T122 ("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T123 ("glInvalidateBufferSubData");
   GL.API.Flush_Mapped_Buffer_Range := Load_T124 ("glFlushMappedBufferRange");
   ...
   GL.API.Gen_Queries := Load_T150 ("glGenQueries");
   GL.API.Delete_Queries := Load_T151 ("glDeleteQueries");
   GL.API.Get_Query_Object := Load_T152 ("glGetQueryObjectuiv");
   GL.API.Get_Shader_Param := Load_T153 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T154 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T155 ("glCreateShader");
   GL.API.Delete_Shader := Load_T156 ("glDeleteShader");
   GL.API.Shader_Source := Load_T157 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T158 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T156 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T159 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T158 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T160 ("glCreateProgram");
   GL.API.Delete_Program := Load_T161 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T162 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T163 ("glAttachShader");
   GL.API.Link_Program := Load_T161 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T164 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T165 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T166 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T167 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T161 ("glUseProgram");
   GL.API.Validate_Program := Load_T161 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T168 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T169 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T170 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T171 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T172 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T172 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T173 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T173 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T174 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T175 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T176 ("glGetFragDataLocation");
   GL.API.Begin_Transform_Feedback := Load_T177 ("glBeginTransformFeedback");
   GL.API.End_Transform_Feedback := Load_T159 ("glEndTransformFeedback");
   GL.API.Get_Transform_Feedback_Varying := Load_T178 ("glGetTransformFeedbackVarying");
   GL.API.Transform_Feedback_Varyings := Load_T179 ("glTransformFeedbackVaryings");
   GL.API.Begin_Query := Load_T180 ("glBeginQuery");
   GL.API.End_Query := Load_T181 ("glEndQuery");
   GL.API.Begin_Query_Indexed := Load_T182 ("glBeginQueryIndexed");
   GL.API.End_Query_Indexed := Load_T183 ("glEndQueryIndexed");
   GL.API.Query_Counter := Load_T184 ("glQueryCounter");
   GL.API.Set_Patch_Parameter_Int := Load_T185 ("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T186 ("glPatchParameterfv");
