...
begin
   ...
   GL.API.Gen_Buffers := Load_T95("glGenBuffers");
   GL.API.Delete_Buffers := Load_T96("glDeleteBuffers");
   GL.API.Bind_Buffer := Load_T97("glBindBuffer");
   GL.API.Buffer_Data := Load_T98("glBufferData");
   GL.API.Map_Buffer := Load_T99("glMapBuffer");
   GL.API.Buffer_Pointer := Load_T100("glGetBufferPointerv");
   GL.API.Buffer_Sub_Data := Load_T101("glBufferSubData");
   GL.API.Unmap_Buffer := Load_T102("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T103("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T104("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T105("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T106("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T107("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T108("glInvalidateBufferSubData");
   GL.API.Gen_Vertex_Arrays := Load_T109("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T110("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T111("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T112("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T113("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T114("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T115("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T116("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T117("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T118("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T119("glClampColor");
   GL.API.Gen_Framebuffers := Load_T120("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T121("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T122("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T123("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T124("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T125("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T126("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T127("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T128("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T129("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T130("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T131("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T132("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T133("glGetFramebufferParameteriv");
   GL.API.Get_Shader_Param := Load_T134("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T135("glGetShaderiv");
   GL.API.Create_Shader := Load_T136("glCreateShader");
   GL.API.Delete_Shader := Load_T137("glDeleteShader");
   GL.API.Shader_Source := Load_T138("glShaderSource");
   GL.API.Get_Shader_Source := Load_T139("glGetShaderSource");
   GL.API.Compile_Shader := Load_T137("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T140("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T139("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T141("glCreateProgram");
   GL.API.Delete_Program := Load_T142("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T143("glGetProgramiv");
   GL.API.Attach_Shader := Load_T144("glAttachShader");
   GL.API.Link_Program := Load_T142("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T145("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T146("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T147("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T148("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T142("glUseProgram");
   GL.API.Validate_Program := Load_T142("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T149("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T150("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T151("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T152("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T153("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T153("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T154("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T154("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T155("glGetAttachedShaders");
   GL.API.Set_Patch_Parameter_Int := Load_T156("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T157("glPatchParameterfv");
