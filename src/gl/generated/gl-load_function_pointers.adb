...
begin
   ...
   GL.API.Framebuffer_Texture_2D := Load_T144 ("glFramebufferTexture2D");
   GL.API.Framebuffer_Texture_Layer := Load_T145 ("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T146 ("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T147 ("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T148 ("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T149 ("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T150 ("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T151 ("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T152 ("glGetFramebufferParameteriv");
   GL.API.Gen_Queries := Load_T153 ("glGenQueries");
   GL.API.Delete_Queries := Load_T154 ("glDeleteQueries");
   GL.API.Is_Query := Load_T155 ("glIsQuery");
   GL.API.Get_Query_Object := Load_T156 ("glGetQueryObjectuiv");
   GL.API.Begin_Query := Load_T157 ("glBeginQuery");
   GL.API.End_Query := Load_T158 ("glEndQuery");
   GL.API.Begin_Query_Indexed := Load_T159 ("glBeginQueryIndexed");
   GL.API.End_Query_Indexed := Load_T160 ("glEndQueryIndexed");
   GL.API.Query_Counter := Load_T161 ("glQueryCounter");
   GL.API.Get_Shader_Param := Load_T162 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T163 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T164 ("glCreateShader");
   GL.API.Delete_Shader := Load_T165 ("glDeleteShader");
   GL.API.Shader_Source := Load_T166 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T167 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T165 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T168 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T167 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T169 ("glCreateProgram");
   GL.API.Delete_Program := Load_T170 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T171 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T172 ("glAttachShader");
   GL.API.Link_Program := Load_T170 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T173 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T174 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T175 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T176 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T170 ("glUseProgram");
   GL.API.Validate_Program := Load_T170 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T177 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T178 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T179 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T180 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T181 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T181 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T182 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T182 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T183 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T184 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T185 ("glGetFragDataLocation");
   GL.API.Begin_Transform_Feedback := Load_T186 ("glBeginTransformFeedback");
   GL.API.End_Transform_Feedback := Load_T168 ("glEndTransformFeedback");
   GL.API.Get_Transform_Feedback_Varying := Load_T187 ("glGetTransformFeedbackVarying");
   GL.API.Transform_Feedback_Varyings := Load_T188 ("glTransformFeedbackVaryings");
   GL.API.Set_Patch_Parameter_Int := Load_T189 ("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T190 ("glPatchParameterfv");
