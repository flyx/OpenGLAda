...
begin
   ...
   GL.API.Tex_Image_3D := Load_T90("glTexImage3D");
   GL.API.Active_Texture := Load_T91("glActiveTexture");
   GL.API.Generate_Mipmap := Load_T92("glGenerateMipmap");
   GL.API.Invalidate_Tex_Image := Load_T93("glInvalidateTexImage");
   GL.API.Invalidate_Tex_Sub_Image := Load_T94("glInvalidateTexSubImage");
   GL.API.Tex_Storage_1D := Load_T95("glTexStorage1D");
   GL.API.Tex_Storage_2D := Load_T96("glTexStorage2D");
   GL.API.Tex_Storage_3D := Load_T97("glTexStorage3D");
   GL.API.Gen_Buffers := Load_T98("glGenBuffers");
   GL.API.Delete_Buffers := Load_T99("glDeleteBuffers");
   GL.API.Bind_Buffer := Load_T100("glBindBuffer");
   GL.API.Buffer_Data := Load_T101("glBufferData");
   GL.API.Map_Buffer := Load_T102("glMapBuffer");
   GL.API.Buffer_Pointer := Load_T103("glGetBufferPointerv");
   GL.API.Buffer_Sub_Data := Load_T104("glBufferSubData");
   GL.API.Unmap_Buffer := Load_T105("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T106("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T107("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T108("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T109("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T110("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T111("glInvalidateBufferSubData");
   GL.API.Gen_Vertex_Arrays := Load_T112("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T113("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T114("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T115("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T116("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T117("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T118("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T119("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T120("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T121("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T122("glClampColor");
   GL.API.Gen_Framebuffers := Load_T123("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T124("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T125("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T126("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T127("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T128("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T129("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T130("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T131("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T132("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T133("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T134("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T135("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T136("glGetFramebufferParameteriv");
   GL.API.Get_Shader_Param := Load_T137("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T138("glGetShaderiv");
   GL.API.Create_Shader := Load_T139("glCreateShader");
   GL.API.Delete_Shader := Load_T140("glDeleteShader");
   GL.API.Shader_Source := Load_T141("glShaderSource");
   GL.API.Get_Shader_Source := Load_T142("glGetShaderSource");
   GL.API.Compile_Shader := Load_T140("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T143("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T142("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T144("glCreateProgram");
   GL.API.Delete_Program := Load_T145("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T146("glGetProgramiv");
   GL.API.Attach_Shader := Load_T147("glAttachShader");
   GL.API.Link_Program := Load_T145("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T148("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T149("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T150("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T151("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T145("glUseProgram");
   GL.API.Validate_Program := Load_T145("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T152("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T153("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T154("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T155("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T156("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T156("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T157("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T157("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T158("glGetAttachedShaders");
   GL.API.Set_Patch_Parameter_Int := Load_T159("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T160("glPatchParameterfv");
