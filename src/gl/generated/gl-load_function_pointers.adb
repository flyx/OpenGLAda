...
begin
   ...
   GL.API.Blend_Func_I := Load_T74 ("glBlendFunci");
   GL.API.Blend_Func_Separate := Load_T75 ("glBlendFuncSeparate");
   GL.API.Blend_Func_Separate_I := Load_T76 ("glBlendFuncSeparate");
   GL.API.Blend_Color := Load_T77 ("glBlendColor");
   GL.API.Blend_Equation := Load_T78 ("glBlendEquation");
   GL.API.Blend_Equation_I := Load_T79 ("glBlendEquationi");
   GL.API.Blend_Equation_Separate := Load_T80 ("glBlendEquationSeparate");
   GL.API.Blend_Equation_Separate_I := Load_T81 ("glBlendEquationi");
   GL.API.Set_Point_Parameter_Single := Load_T82 ("glPointParameterf");
   GL.API.Draw_Buffers := Load_T83 ("glDrawBuffers");
   GL.API.Clear_Accum := Load_T77 ("glClearAccum");
   GL.API.Clear_Buffer := Load_T84 ("glClearBufferfv");
   GL.API.Clear_Draw_Buffer := Load_T85 ("glClearBufferfv");
   GL.API.Clear_Buffer_Depth := Load_T86 ("glClearBufferfv");
   GL.API.Clear_Buffer_Stencil := Load_T87 ("glClearBufferiv");
   GL.API.Clear_Buffer_Depth_Stencil := Load_T88 ("glClearBufferfi");
   GL.API.Stencil_Func_Separate := Load_T89 ("glStencilFuncSeparate");
   GL.API.Stencil_Op_Separate := Load_T90 ("glStencilOpSeparate");
   GL.API.Stencil_Mask_Separate := Load_T91 ("glStencilMaskSeparate");
   GL.API.Compressed_Tex_Image_1D := Load_T92 ("glCompressedTexImage1D");
   GL.API.Tex_Sub_Image_1D := Load_T93 ("glTexSubImage1D");
   GL.API.Tex_Storage_1D := Load_T94 ("glTexStorage1D");
   GL.API.Compressed_Tex_Image_2D := Load_T95 ("glCompressedTexImage2D");
   GL.API.Tex_Storage_2D := Load_T96 ("glTexStorage2D");
   GL.API.Tex_Image_3D := Load_T97 ("glTexImage3D");
   GL.API.Compressed_Tex_Image_3D := Load_T98 ("glCompressedTexImage3D");
   GL.API.Tex_Sub_Image_3D := Load_T93 ("glTexSubImage3D");
   GL.API.Tex_Storage_3D := Load_T99 ("glTexStorage3D");
   GL.API.Active_Texture := Load_T100 ("glActiveTexture");
   GL.API.Generate_Mipmap := Load_T101 ("glGenerateMipmap");
   GL.API.Invalidate_Tex_Image := Load_T102 ("glInvalidateTexImage");
   GL.API.Invalidate_Tex_Sub_Image := Load_T103 ("glInvalidateTexSubImage");
   GL.API.Gen_Buffers := Load_T104 ("glGenBuffers");
   GL.API.Delete_Buffers := Load_T105 ("glDeleteBuffers");
   ...
   GL.API.Buffer_Sub_Data := Load_T112 ("glBufferSubData");
   GL.API.Unmap_Buffer := Load_T113 ("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T114 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T115 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T116 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T117 ("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T118 ("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T119 ("glInvalidateBufferSubData");
   GL.API.Gen_Vertex_Arrays := Load_T120 ("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T121 ("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T122 ("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T123 ("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T124 ("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T125 ("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T126 ("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T127 ("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T128 ("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T129 ("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T130 ("glClampColor");
   GL.API.Gen_Framebuffers := Load_T131 ("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T132 ("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T133 ("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T134 ("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T135 ("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T136 ("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T137 ("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T138 ("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T139 ("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T140 ("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T141 ("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T142 ("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T143 ("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T144 ("glGetFramebufferParameteriv");
   GL.API.Get_Shader_Param := Load_T145 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T146 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T147 ("glCreateShader");
   GL.API.Delete_Shader := Load_T148 ("glDeleteShader");
   GL.API.Shader_Source := Load_T149 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T150 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T148 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T151 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T150 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T152 ("glCreateProgram");
   GL.API.Delete_Program := Load_T153 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T154 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T155 ("glAttachShader");
   GL.API.Link_Program := Load_T153 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T156 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T157 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T158 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T159 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T153 ("glUseProgram");
   GL.API.Validate_Program := Load_T153 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T160 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T161 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T162 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T163 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T164 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T164 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T165 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T165 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T166 ("glGetAttachedShaders");
   ...
   GL.API.Set_Patch_Parameter_Float_Array := Load_T173 ("glPatchParameterfv");
