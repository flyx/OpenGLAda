...
begin
   ...
   GL.API.Map_Buffer_Range := Load_T114 ("glMapBufferRange");
   GL.API.Buffer_Pointer := Load_T115 ("glGetBufferPointerv");
   GL.API.Buffer_Sub_Data := Load_T116 ("glBufferSubData");
   GL.API.Get_Buffer_Sub_Data := Load_T117 ("glGetBufferSubData");
   ...
   GL.API.Flush_Mapped_Buffer_Range := Load_T125 ("glFlushMappedBufferRange");
   GL.API.Gen_Vertex_Arrays := Load_T126 ("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T127 ("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T128 ("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T129 ("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T130 ("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T131 ("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T132 ("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T133 ("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T134 ("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T135 ("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T136 ("glClampColor");
   GL.API.Gen_Framebuffers := Load_T137 ("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T138 ("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T139 ("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T140 ("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T141 ("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T142 ("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T143 ("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T144 ("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T145 ("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T146 ("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T147 ("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T148 ("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T149 ("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T150 ("glGetFramebufferParameteriv");
   GL.API.Gen_Queries := Load_T151 ("glGenQueries");
   GL.API.Delete_Queries := Load_T152 ("glDeleteQueries");
   GL.API.Is_Query := Load_T153 ("glIsQuery");
   GL.API.Get_Query_Object := Load_T154 ("glGetQueryObjectuiv");
   GL.API.Begin_Query := Load_T155 ("glBeginQuery");
   GL.API.End_Query := Load_T156 ("glEndQuery");
   GL.API.Begin_Query_Indexed := Load_T157 ("glBeginQueryIndexed");
   GL.API.End_Query_Indexed := Load_T158 ("glEndQueryIndexed");
   GL.API.Query_Counter := Load_T159 ("glQueryCounter");
   GL.API.Get_Shader_Param := Load_T160 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T161 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T162 ("glCreateShader");
   GL.API.Delete_Shader := Load_T163 ("glDeleteShader");
   GL.API.Shader_Source := Load_T164 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T165 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T163 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T166 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T165 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T167 ("glCreateProgram");
   GL.API.Delete_Program := Load_T168 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T169 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T170 ("glAttachShader");
   GL.API.Link_Program := Load_T168 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T171 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T172 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T173 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T174 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T168 ("glUseProgram");
   GL.API.Validate_Program := Load_T168 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T175 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T176 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T177 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T178 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T179 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T179 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T180 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T180 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T181 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T182 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T183 ("glGetFragDataLocation");
   GL.API.Begin_Transform_Feedback := Load_T184 ("glBeginTransformFeedback");
   GL.API.End_Transform_Feedback := Load_T166 ("glEndTransformFeedback");
   GL.API.Get_Transform_Feedback_Varying := Load_T185 ("glGetTransformFeedbackVarying");
   GL.API.Transform_Feedback_Varyings := Load_T186 ("glTransformFeedbackVaryings");
   GL.API.Set_Patch_Parameter_Int := Load_T187 ("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T188 ("glPatchParameterfv");
