...
begin
   ...
   GL.API.Query_Counter := Load_T153 ("glQueryCounter");
   GL.API.Get_Shader_Param := Load_T154 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T155 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T156 ("glCreateShader");
   GL.API.Delete_Shader := Load_T157 ("glDeleteShader");
   GL.API.Shader_Source := Load_T158 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T159 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T157 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T160 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T159 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T161 ("glCreateProgram");
   GL.API.Delete_Program := Load_T162 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T163 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T164 ("glAttachShader");
   GL.API.Link_Program := Load_T162 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T165 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T166 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T167 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T168 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T162 ("glUseProgram");
   GL.API.Validate_Program := Load_T162 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T169 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T170 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T171 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T172 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T173 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T173 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T174 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T174 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T175 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T176 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T177 ("glGetFragDataLocation");
   GL.API.Begin_Transform_Feedback := Load_T178 ("glBeginTransformFeedback");
   GL.API.End_Transform_Feedback := Load_T160 ("glEndTransformFeedback");
   GL.API.Get_Transform_Feedback_Varying := Load_T179 ("glGetTransformFeedbackVarying");
   GL.API.Transform_Feedback_Varyings := Load_T180 ("glTransformFeedbackVaryings");
   GL.API.Set_Patch_Parameter_Int := Load_T181 ("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T182 ("glPatchParameterfv");
