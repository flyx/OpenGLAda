...
begin
   ...
   GL.API.Texture_Buffer_Data := Load_T106 ("glTexBuffer");
   GL.API.Map_Buffer := Load_T107 ("glMapBuffer");
   GL.API.Buffer_Pointer := Load_T108 ("glGetBufferPointerv");
   GL.API.Buffer_Sub_Data := Load_T109 ("glBufferSubData");
   GL.API.Unmap_Buffer := Load_T110 ("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T111 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T112 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T113 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T114 ("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T115 ("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T116 ("glInvalidateBufferSubData");
   GL.API.Gen_Vertex_Arrays := Load_T117 ("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T118 ("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T119 ("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T120 ("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T121 ("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T122 ("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T123 ("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T124 ("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T125 ("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T126 ("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T127 ("glClampColor");
   GL.API.Gen_Framebuffers := Load_T128 ("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T129 ("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T130 ("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T131 ("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T132 ("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T133 ("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T134 ("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T135 ("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T136 ("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T137 ("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T138 ("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T139 ("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T140 ("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T141 ("glGetFramebufferParameteriv");
   GL.API.Get_Shader_Param := Load_T142 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T143 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T144 ("glCreateShader");
   GL.API.Delete_Shader := Load_T145 ("glDeleteShader");
   GL.API.Shader_Source := Load_T146 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T147 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T145 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T148 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T147 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T149 ("glCreateProgram");
   GL.API.Delete_Program := Load_T150 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T151 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T152 ("glAttachShader");
   GL.API.Link_Program := Load_T150 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T153 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T154 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T155 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T156 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T150 ("glUseProgram");
   GL.API.Validate_Program := Load_T150 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T157 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T158 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T159 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T160 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T161 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T161 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T162 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T162 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T163 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T164 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T165 ("glGetFragDataLocation");
   GL.API.Set_Patch_Parameter_Int := Load_T166 ("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T167 ("glPatchParameterfv");
