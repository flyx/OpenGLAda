...
begin
   ...
   GL.API.Get_Buffer_Sub_Data := Load_T116 ("glGetBufferSubData");
   ...
   GL.API.Is_Query := Load_T152 ("glIsQuery");
   GL.API.Get_Query_Object := Load_T153 ("glGetQueryObjectuiv");
   GL.API.Query_Counter := Load_T154 ("glQueryCounter");
   GL.API.Get_Shader_Param := Load_T155 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T156 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T157 ("glCreateShader");
   GL.API.Delete_Shader := Load_T158 ("glDeleteShader");
   GL.API.Shader_Source := Load_T159 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T160 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T158 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T161 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T160 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T162 ("glCreateProgram");
   GL.API.Delete_Program := Load_T163 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T164 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T165 ("glAttachShader");
   GL.API.Link_Program := Load_T163 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T166 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T167 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T168 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T169 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T163 ("glUseProgram");
   GL.API.Validate_Program := Load_T163 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T170 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T171 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T172 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T173 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T174 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T174 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T175 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T175 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T176 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T177 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T178 ("glGetFragDataLocation");
   GL.API.Begin_Transform_Feedback := Load_T179 ("glBeginTransformFeedback");
   GL.API.End_Transform_Feedback := Load_T161 ("glEndTransformFeedback");
   GL.API.Get_Transform_Feedback_Varying := Load_T180 ("glGetTransformFeedbackVarying");
   GL.API.Transform_Feedback_Varyings := Load_T181 ("glTransformFeedbackVaryings");
   GL.API.Set_Patch_Parameter_Int := Load_T182 ("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T183 ("glPatchParameterfv");
