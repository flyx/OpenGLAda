...
begin
   ...
   GL.API.Bind_Image_Texture := Load_T95 ("glBindImageTexture");
   GL.API.Compressed_Tex_Image_1D := Load_T96 ("glCompressedTexImage1D");
   GL.API.Tex_Sub_Image_1D := Load_T97 ("glTexSubImage1D");
   GL.API.Tex_Storage_1D := Load_T98 ("glTexStorage1D");
   GL.API.Compressed_Tex_Image_2D := Load_T99 ("glCompressedTexImage2D");
   GL.API.Tex_Storage_2D := Load_T100 ("glTexStorage2D");
   GL.API.Tex_Image_3D := Load_T101 ("glTexImage3D");
   GL.API.Compressed_Tex_Image_3D := Load_T102 ("glCompressedTexImage3D");
   GL.API.Tex_Sub_Image_3D := Load_T97 ("glTexSubImage3D");
   GL.API.Tex_Storage_3D := Load_T103 ("glTexStorage3D");
   GL.API.Active_Texture := Load_T104 ("glActiveTexture");
   GL.API.Generate_Mipmap := Load_T105 ("glGenerateMipmap");
   GL.API.Invalidate_Tex_Image := Load_T106 ("glInvalidateTexImage");
   GL.API.Invalidate_Tex_Sub_Image := Load_T107 ("glInvalidateTexSubImage");
   GL.API.Gen_Buffers := Load_T108 ("glGenBuffers");
   GL.API.Gen_Transform_Feedbacks := Load_T108 ("glGenTransformFeedbacks");
   GL.API.Delete_Buffers := Load_T109 ("glDeleteBuffers");
   GL.API.Delete_Transform_Feedbacks := Load_T109 ("glDeleteTransformFeedbacks");
   GL.API.Bind_Buffer := Load_T110 ("glBindBuffer");
   GL.API.Bind_Transform_Feedback := Load_T110 ("glBindTransformFeedback");
   GL.API.Bind_Buffer_Base := Load_T111 ("glBindBufferBase");
   GL.API.Buffer_Data := Load_T112 ("glBufferData");
   GL.API.Texture_Buffer_Data := Load_T113 ("glTexBuffer");
   GL.API.Map_Buffer := Load_T114 ("glMapBuffer");
   GL.API.Map_Buffer_Range := Load_T115 ("glMapBufferRange");
   GL.API.Buffer_Pointer := Load_T116 ("glGetBufferPointerv");
   GL.API.Buffer_Sub_Data := Load_T117 ("glBufferSubData");
   GL.API.Unmap_Buffer := Load_T118 ("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T119 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T120 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T121 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T122 ("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T123 ("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T124 ("glInvalidateBufferSubData");
   GL.API.Gen_Vertex_Arrays := Load_T125 ("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T126 ("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T127 ("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T128 ("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T129 ("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T130 ("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T131 ("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T132 ("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T133 ("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T134 ("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T135 ("glClampColor");
   GL.API.Gen_Framebuffers := Load_T136 ("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T137 ("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T138 ("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T139 ("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T140 ("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T141 ("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T142 ("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T143 ("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T144 ("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T145 ("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T146 ("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T147 ("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T148 ("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T149 ("glGetFramebufferParameteriv");
   GL.API.Get_Shader_Param := Load_T150 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T151 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T152 ("glCreateShader");
   GL.API.Delete_Shader := Load_T153 ("glDeleteShader");
   GL.API.Shader_Source := Load_T154 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T155 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T153 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T156 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T155 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T157 ("glCreateProgram");
   GL.API.Delete_Program := Load_T158 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T159 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T160 ("glAttachShader");
   GL.API.Link_Program := Load_T158 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T161 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T162 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T163 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T164 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T158 ("glUseProgram");
   GL.API.Validate_Program := Load_T158 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T165 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T166 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T167 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T168 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T169 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T169 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T170 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T170 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T171 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T172 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T173 ("glGetFragDataLocation");
   GL.API.Begin_Transform_Feedback := Load_T174 ("glBeginTransformFeedback");
   GL.API.End_Transform_Feedback := Load_T156 ("glEndTransformFeedback");
   GL.API.Get_Transform_Feedback_Varying := Load_T175 ("glGetTransformFeedbackVarying");
   GL.API.Transform_Feedback_Varyings := Load_T176 ("glTransformFeedbackVaryings");
   GL.API.Dispatch_Compute := Load_T177 ("glDispatchCompute");
   GL.API.Memory_Barrier := Load_T178 ("glMemoryBarrier");
