...
begin
   ...
   GL.API.Compressed_Tex_Image_2D := Load_T91("glCompressedTexImage2D");
   GL.API.Tex_Image_3D := Load_T92("glTexImage3D");
   GL.API.Compressed_Tex_Image_3D := Load_T93("glCompressedTexImage3D");
   GL.API.Active_Texture := Load_T94("glActiveTexture");
   GL.API.Generate_Mipmap := Load_T95("glGenerateMipmap");
   GL.API.Invalidate_Tex_Image := Load_T96("glInvalidateTexImage");
   GL.API.Invalidate_Tex_Sub_Image := Load_T97("glInvalidateTexSubImage");
   GL.API.Tex_Storage_1D := Load_T98("glTexStorage1D");
   GL.API.Tex_Storage_2D := Load_T99("glTexStorage2D");
   GL.API.Tex_Storage_3D := Load_T100("glTexStorage3D");
