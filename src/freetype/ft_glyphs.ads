...
package FT_Glyphs is
   ...
   function Get_Bitmap (Glyph_Slot : FT.Types.FT_Glyph_Slot_Ptr) return FT_Image.FT_Bitmap;
   ...
   function Get_Glyph_Advance (Slot_Ptr : FT.Types.FT_Glyph_Slot_Ptr) return FT_Image.FT_Vector;
   function Get_Glyph_Record (Face_Ptr : FT_Interface.FT_Face) return FT_Glyph_Record;
   function Get_Glyph_Format (Slot_Ptr : FT.Types.FT_Glyph_Slot_Ptr) return FT_Image.FT_Glyph_Format;
