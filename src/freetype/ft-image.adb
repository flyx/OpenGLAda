...
package body FT.Image is
   ...
   function Get_Buffer (Bitmap : Bitmap_Record) return GL.Objects.Textures.Image_Source is
   ...
   function Get_Num_Grays (Bitmap : Bitmap_Record) return GL.Types.Short is
   begin
   ...
   function Get_Palette_Mode (Bitmap : Bitmap_Record) return unsigned_char is
   begin
   ...
   function Get_Pitch (Bitmap : Bitmap_Record) return GL.Types.Int is
   begin
      return Bitmap.Pitch;
   end Get_Pitch;
   ...
   function Get_Pixel_Mode (Bitmap : Bitmap_Record) return unsigned_char is
   begin
   ...
   function Get_Rows (Bitmap : Bitmap_Record) return GL.Types.Int is
   begin
   ...
   function Get_Width (Bitmap : Bitmap_Record) return GL.Types.UInt is
   begin
      return Bitmap.Width;
   end Get_Width;
