...
package Tokenization is
   ...
   Keyword_Dynamic   : constant Symbol_Id := 2;
   Keyword_End       : constant Symbol_Id := 3;
   Keyword_Function  : constant Symbol_Id := 4;
   Keyword_In        : constant Symbol_Id := 5;
   Keyword_Is        : constant Symbol_Id := 6;
   Keyword_Out       : constant Symbol_Id := 7;
   Keyword_Package   : constant Symbol_Id := 8;
   Keyword_Pragma    : constant Symbol_Id := 9;
   Keyword_Procedure : constant Symbol_Id := 10;
   Keyword_Return    : constant Symbol_Id := 11;
   Keyword_Spec      : constant Symbol_Id := 12;
   Keyword_Static    : constant Symbol_Id := 13;
   Keyword_Subtype   : constant Symbol_Id := 14;
   Keyword_Type      : constant Symbol_Id := 15;
   Keyword_Use       : constant Symbol_Id := 16;
   Keyword_With      : constant Symbol_Id := 17;
private
