...
private package GL.API is
   ...
   type T75 is access procedure (P1 : Enums.Getter.Parameter; P2 : UInt; P3 : access Int);
   pragma Convention (StdCall, T75);
   type T76 is access function (P1 : Enums.Getter.String_Parameter; P2 : UInt) return C.Strings.chars_ptr;
   pragma Convention (StdCall, T76);
   type T77 is access procedure (P1 : Colors.Color);
   pragma Convention (StdCall, T77);
   type T78 is access procedure (P1 : Double);
   pragma Convention (StdCall, T78);
   type T79 is access procedure (P1 : Connection_Mode; P2 : Size; P3 : Size; P4 : Size);
   pragma Convention (StdCall, T79);
   type T80 is access procedure (P1 : Connection_Mode; P2 : Size; P3 : Unsigned_Numeric_Type; P4 : Low_Level.IntPtr; P5 : Size);
   pragma Convention (StdCall, T80);
   type T81 is access procedure (P1 : Connection_Mode; P2 : UInt; P3 : Unsigned_Numeric_Type; P4 : UInt; P5 : Int);
   pragma Convention (StdCall, T81);
   type T82 is access procedure (P1 : Connection_Mode; P2 : UInt);
   pragma Convention (StdCall, T82);
   type T83 is access procedure (P1 : Connection_Mode; P2 : UInt; P3 : UInt);
   pragma Convention (StdCall, T83);
   type T84 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T84);
   type T85 is access procedure (P1 : GL.Attributes.Attribute; P2 : UInt);
   ...
   type T88 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3, P4, P5 : Blending.Blend_Factor);
   pragma Convention (StdCall, T88);
   type T89 is access procedure (P1, P2, P3, P4 : Colors.Component);
   pragma Convention (StdCall, T89);
   type T90 is access procedure (P1 : Blending.Equation);
   pragma Convention (StdCall, T90);
   type T91 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2 : Blending.Equation);
   pragma Convention (StdCall, T91);
   type T92 is access procedure (P1, P2 : Blending.Equation);
   pragma Convention (StdCall, T92);
   type T93 is access procedure (P1 : Buffers.Draw_Buffer_Index; P2, P3 : Blending.Equation);
   pragma Convention (StdCall, T93);
   type T94 is access procedure (P1 : Enums.Point_Param; P2 : Single);
   pragma Convention (StdCall, T94);
   type T95 is access procedure (P1 : UInt; P2 : Buffers.Explicit_Color_Buffer_List);
   pragma Convention (StdCall, T95);
   type T96 is access procedure (P1 : Buffers.Color_Buffer_Selector; P2 : Low_Level.Zero; P3 : Colors.Color);
   pragma Convention (StdCall, T96);
   type T97 is access procedure (P1 : Low_Level.Enums.Only_Color_Buffer; P2 : Buffers.Draw_Buffer_Index; P3 : Colors.Color);
   pragma Convention (StdCall, T97);
   type T98 is access procedure (P1 : Low_Level.Enums.Only_Depth_Buffer; P2 : Low_Level.Zero; P3 : access constant Buffers.Depth);
   pragma Convention (StdCall, T98);
   type T99 is access procedure (P1 : Low_Level.Enums.Only_Stencil_Buffer; P2 : Low_Level.Zero; P3 : access constant Buffers.Stencil_Index);
   pragma Convention (StdCall, T99);
   type T100 is access procedure (P1 : Low_Level.Enums.Only_Depth_Stencil_Buffer; P2 : Low_Level.Zero; P3 : Buffers.Depth; P4 : Buffers.Stencil_Index);
   pragma Convention (StdCall, T100);
   type T101 is access procedure (P1 : Culling.Face_Selector; P2 : Compare_Function; P3 : Int; P4 : UInt);
   pragma Convention (StdCall, T101);
   type T102 is access procedure (P1 : Culling.Face_Selector; P2, P3, P4 : Buffers.Stencil_Action);
   pragma Convention (StdCall, T102);
   type T103 is access procedure (P1 : Culling.Face_Selector; P2 : UInt);
   pragma Convention (StdCall, T103);
   type T104 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4 : Size; P5 : Low_Level.Zero; P6 : Size; P7 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T104);
   type T105 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3, P4 : Int; P5, P6 : Size; P7 : Pixels.Data_Format; P8 : Pixels.Data_Type; P9 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T105);
   type T106 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4 : Size);
   pragma Convention (StdCall, T106);
   type T107 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5 : Size; P6 : Low_Level.Zero; P7 : Size; P8 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T107);
   type T108 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T108);
   type T109 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Pixels.Data_Format; P9 : Pixels.Data_Type; P10 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T109);
   type T110 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size; P7 : Low_Level.Zero; P8 : Size; P9 : Objects.Textures.Image_Source);
   pragma Convention (StdCall, T110);
   type T111 is access procedure (P1 : Low_Level.Enums.Texture_Kind; P2 : Objects.Textures.Mipmap_Level; P3 : Pixels.Internal_Format; P4, P5, P6 : Size);
   pragma Convention (StdCall, T111);
   type T112 is access procedure (P1 : Int);
   pragma Convention (StdCall, T112);
   type T113 is access procedure (P1 : Low_Level.Enums.Texture_Kind);
   pragma Convention (StdCall, T113);
   type T114 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T114);
   type T115 is access procedure (P1 : UInt; P2 : Objects.Textures.Mipmap_Level; P3, P4, P5 : Int; P6, P7, P8 : Size);
   pragma Convention (StdCall, T115);
   type T116 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T116);
   type T117 is access procedure (P1 : Size; P2 : UInt_Array);
   pragma Convention (StdCall, T117);
   type T118 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T118);
   type T119 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : UInt; P3 : UInt);
   pragma Convention (StdCall, T119);
   type T120 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.SizeIPtr; P3 : System.Address; P4 : Objects.Buffers.Buffer_Usage);
   ...
   type T196 is access procedure (P1, P2, P3 : UInt);
   pragma Convention (StdCall, T196);
   type T197 is access procedure (P1 : Low_Level.Bitfield);
   pragma Convention (StdCall, T197);
   procedure Flush;
   ...
   Draw_Elements_Instanced : T80;
   Draw_Elements_Base_Vertex : T81;
   Draw_Transform_Feedback : T82;
   Draw_Transform_Feedback_Stream : T83;
   Primitive_Restart_Index : T84;
   Vertex_Attrib_Divisor : T85;
   ...
   Blend_Func_I : T86;
   Blend_Func_Separate : T87;
   Blend_Func_Separate_I : T88;
   Blend_Color : T89;
   Blend_Equation : T90;
   Blend_Equation_I : T91;
   Blend_Equation_Separate : T92;
   Blend_Equation_Separate_I : T93;
   ...
   Set_Point_Parameter_Single : T94;
   ...
   Clear_Accum : T89;
   Clear_Buffer : T96;
   Clear_Draw_Buffer : T97;
   Clear_Buffer_Depth : T98;
   Clear_Buffer_Stencil : T99;
   Clear_Buffer_Depth_Stencil : T100;
   ...
   Stencil_Func_Separate : T101;
   Stencil_Op_Separate : T102;
   Stencil_Mask_Separate : T103;
   ...
   Compressed_Tex_Image_1D : T104;
   Tex_Sub_Image_1D : T105;
   Tex_Storage_1D : T106;
   ...
   Tex_Storage_2D : T108;
   Tex_Image_3D : T109;
   Compressed_Tex_Image_3D : T110;
   Tex_Sub_Image_3D : T105;
   Tex_Storage_3D : T111;
   ...
   Active_Texture : T112;
   Generate_Mipmap : T113;
   Invalidate_Tex_Image : T114;
   Invalidate_Tex_Sub_Image : T115;
   Gen_Buffers : T116;
   Gen_Transform_Feedbacks : T116;
   Delete_Buffers : T117;
   Delete_Transform_Feedbacks : T117;
   Bind_Buffer : T118;
   Bind_Transform_Feedback : T118;
   Bind_Buffer_Base : T119;
   Buffer_Data : T120;
   ...
   Dispatch_Compute : T196;
   Memory_Barrier : T197;
   Memory_Barrier_By_Region : T197;
end GL.API;
