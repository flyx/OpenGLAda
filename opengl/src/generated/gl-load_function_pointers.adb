...
procedure GL.Load_Function_Pointers is
   ...
   function Load_T196 is new Load (T196);
   function Load_T197 is new Load (T197);
begin
   ...
   GL.API.Get_Integer_Indexed := Load_T75 ("glGetIntegeri_v");
   GL.API.Get_String_I := Load_T76 ("glGetStringi");
   GL.API.Secondary_Color := Load_T77 ("glSecondaryColor3dv");
   GL.API.Fog_Coord := Load_T78 ("glFogCoordd");
   GL.API.Draw_Arrays_Instanced := Load_T79 ("glDrawArraysInstanced");
   GL.API.Draw_Elements_Instanced := Load_T80 ("glDrawElementsInstanced");
   GL.API.Draw_Elements_Base_Vertex := Load_T81 ("glDrawElementsBaseVertex");
   GL.API.Draw_Transform_Feedback := Load_T82 ("glDrawTransformFeedback");
   GL.API.Draw_Transform_Feedback_Stream := Load_T83 ("glDrawTransformFeedbackStream");
   GL.API.Primitive_Restart_Index := Load_T84 ("glPrimitiveRestartIndex");
   GL.API.Vertex_Attrib_Divisor := Load_T85 ("glVertexAttribDivisor");
   GL.API.Blend_Func_I := Load_T86 ("glBlendFunci");
   GL.API.Blend_Func_Separate := Load_T87 ("glBlendFuncSeparate");
   GL.API.Blend_Func_Separate_I := Load_T88 ("glBlendFuncSeparate");
   GL.API.Blend_Color := Load_T89 ("glBlendColor");
   GL.API.Blend_Equation := Load_T90 ("glBlendEquation");
   GL.API.Blend_Equation_I := Load_T91 ("glBlendEquationi");
   GL.API.Blend_Equation_Separate := Load_T92 ("glBlendEquationSeparate");
   GL.API.Blend_Equation_Separate_I := Load_T93 ("glBlendEquationi");
   GL.API.Set_Point_Parameter_Single := Load_T94 ("glPointParameterf");
   GL.API.Draw_Buffers := Load_T95 ("glDrawBuffers");
   GL.API.Clear_Accum := Load_T89 ("glClearAccum");
   GL.API.Clear_Buffer := Load_T96 ("glClearBufferfv");
   GL.API.Clear_Draw_Buffer := Load_T97 ("glClearBufferfv");
   GL.API.Clear_Buffer_Depth := Load_T98 ("glClearBufferfv");
   GL.API.Clear_Buffer_Stencil := Load_T99 ("glClearBufferiv");
   GL.API.Clear_Buffer_Depth_Stencil := Load_T100 ("glClearBufferfi");
   GL.API.Stencil_Func_Separate := Load_T101 ("glStencilFuncSeparate");
   GL.API.Stencil_Op_Separate := Load_T102 ("glStencilOpSeparate");
   GL.API.Stencil_Mask_Separate := Load_T103 ("glStencilMaskSeparate");
   GL.API.Compressed_Tex_Image_1D := Load_T104 ("glCompressedTexImage1D");
   GL.API.Tex_Sub_Image_1D := Load_T105 ("glTexSubImage1D");
   GL.API.Tex_Storage_1D := Load_T106 ("glTexStorage1D");
   GL.API.Compressed_Tex_Image_2D := Load_T107 ("glCompressedTexImage2D");
   GL.API.Tex_Storage_2D := Load_T108 ("glTexStorage2D");
   GL.API.Tex_Image_3D := Load_T109 ("glTexImage3D");
   GL.API.Compressed_Tex_Image_3D := Load_T110 ("glCompressedTexImage3D");
   GL.API.Tex_Sub_Image_3D := Load_T105 ("glTexSubImage3D");
   GL.API.Tex_Storage_3D := Load_T111 ("glTexStorage3D");
   GL.API.Active_Texture := Load_T112 ("glActiveTexture");
   GL.API.Generate_Mipmap := Load_T113 ("glGenerateMipmap");
   GL.API.Invalidate_Tex_Image := Load_T114 ("glInvalidateTexImage");
   GL.API.Invalidate_Tex_Sub_Image := Load_T115 ("glInvalidateTexSubImage");
   GL.API.Gen_Buffers := Load_T116 ("glGenBuffers");
   GL.API.Gen_Transform_Feedbacks := Load_T116 ("glGenTransformFeedbacks");
   GL.API.Delete_Buffers := Load_T117 ("glDeleteBuffers");
   GL.API.Delete_Transform_Feedbacks := Load_T117 ("glDeleteTransformFeedbacks");
   GL.API.Bind_Buffer := Load_T118 ("glBindBuffer");
   GL.API.Bind_Transform_Feedback := Load_T118 ("glBindTransformFeedback");
   GL.API.Bind_Buffer_Base := Load_T119 ("glBindBufferBase");
   GL.API.Buffer_Data := Load_T120 ("glBufferData");
   ...
   GL.API.Dispatch_Compute := Load_T196 ("glDispatchCompute");
   GL.API.Memory_Barrier := Load_T197 ("glMemoryBarrier");
   GL.API.Memory_Barrier_By_Region := Load_T197 ("glMemoryBarrierByRegion");
